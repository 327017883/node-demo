...
(function(L, S) {
    ...
    (function(a) {
        ...
        a.Fx.prototype = {
            dSetter: function() {
                var a = this.paths[0], f = this.paths[1], h = [], l = this.now, w = a.length, t;
                if (1 === l)
                    h = this.toD;
                else if (w === f.length && 1 > l)
                    for (; w--; )
                        t = parseFloat(a[w]),
                        h[w] = isNaN(t) ? a[w] : l * parseFloat(f[w] - t) + t;
                else
                    h = f;
            ...
            update: function() {
                ...
                if (this[f + "Setter"])
                    ...
                    a.attr ? a.element && a.attr(f, h, null, !0) : a.style[f] = h + this.unit;
                l && l.call(a, h, this)
            },
            run: function(a, f, h) {
                var n = this, w = function(a) {
            ...
            step: function(n) {
                var f = +new Date, h, l = this.options, w = this.elem, t = l.complete, e = l.duration, d = l.curAnim;
                w.attr && !w.element ? n = !1 : n || f >= e + this.startTime ? (this.now = this.end,
                this.pos = 1,
                this.update(),
                h = d[this.prop] = !0,
                ...
                h && t && t.call(w),
                n = !1) : (this.pos = l.easing((f - this.startTime) / e),
            ...
            initPath: function(n, f, h) {
                function l(a) {
                    ...
                    for (u = a.length; u--; )
                        b = "M" === a[u] || "L" === a[u],
                        c = /[a-zA-Z]/.test(a[u + 3]),
                        b && c && a.splice(u + 1, 0, a[u + 1], a[u + 2], a[u + 1], a[u + 2])
                }
                function w(a, c) {
                    for (; a.length < x; ) {
                        a[0] = c[x - a.length];
                        ...
                        B && (k = a.slice(a.length - b),
                        [].splice.apply(a, [a.length, 0].concat(k)),
                        u--)
                    }
                    a[0] = "M"
                }
                function t(a, k) {
                    for (var p = (x - a.length) / b; 0 < p && p--; )
                        c = a.slice().splice(a.length / I - b, b * I),
                        c[0] = k[x - b - p * b],
                        C && (c[b - 6] = c[b - 2],
                        c[b - 5] = c[b - 1]),
                        [].splice.apply(a, [a.length / I, 0].concat(c)),
                        B && p--
                }
                f = f || "";
                var e, d = n.startX, m = n.endX, C = -1 < f.indexOf("C"), b = C ? 7 : 3, x, c, u;
                f = f.split(" ");
                h = h.slice();
                var B = n.isArea, I = B ? 2 : 1, k;
                C && (l(f),
                l(h));
                if (d && m) {
                ...
                f.length && a.isNumber(e) && (x = h.length + e * I * b,
                k ? (w(f, h),
                t(h, f)) : (w(h, f),
                t(f, h)));
                return [f, h]
        ...
        ;
        a.merge = function() {
            var n, f = arguments, h, l = {}, w = function(f, e) {
                "object" !== typeof f && (f = {});
        ...
        a.syncTimeout = function(a, f, h) {
            if (f)
                return setTimeout(a, f, h);
            a.call(0, h)
        }
        ;
        a.pick = function() {
            var a = arguments, f, h, l = a.length;
            for (f = 0; f < l; f++)
                if (h = a[f],
                void 0 !== h && null !== h)
                    return h
        ...
        a.dateFormat = function(n, f, h) {
            ...
            a.objectEach(l, function(a, b) {
                for (; -1 !== n.indexOf("%" + b); )
                    n = n.replace("%" + b, "function" === typeof a ? a(f) : a)
            });
        ...
        a.formatSingle = function(n, f) {
            ...
            /f$/.test(n) ? (h = (h = n.match(h)) ? h[1] : -1,
            null !== f && (f = a.numberFormat(f, h, l.decimalPoint, -1 < n.indexOf(",") ? l.thousandsSep : ""))) : f = a.dateFormat(n, f);
            return f
        }
        ;
        ...
        a.normalizeTickInterval = function(n, f, h, l, w) {
            ...
            h = a.pick(h, 1);
            t = n / h;
            f || (f = w ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10],
            !1 === l && (1 === h ? f = a.grep(f, function(a) {
                return 0 === a % 1
            }) : .1 >= h && (f = [1 / h])));
            for (l = 0; l < f.length && !(e = f[l],
            w && e * h >= n || !w && t <= (f[l] + (f[l + 1] || f[l])) / 2); l++)
                ;
        ...
        a.numberFormat = function(n, f, h, l) {
            n = +n || 0;
            f = +f;
            var w = a.defaultOptions.lang, t = (n.toString().split(".")[1] || "").length, e, d;
        ...
        a.getStyle = function(n, f, h) {
            if ("width" === f)
                return Math.min(n.offsetWidth, n.scrollWidth) - a.getStyle(n, "padding-left") - a.getStyle(n, "padding-right");
            if ("height" === f)
                return Math.min(n.offsetHeight, n.scrollHeight) - a.getStyle(n, "padding-top") - a.getStyle(n, "padding-bottom");
            if (n = F.getComputedStyle(n, void 0))
                n = n.getPropertyValue(f),
                a.pick(h, !0) && (n = a.pInt(n));
            return n
        }
        ;
        ...
        ;
        a.map = function(a, f) {
            for (var h = [], l = 0, n = a.length; l < n; l++)
                h[l] = f.call(a[l], a[l], l, a);
            return h
        }
        ;
        a.offset = function(a) {
        ...
        a.stop = function(a, f) {
            for (var h = D.length; h--; )
                D[h].elem !== a || f && f !== D[h].prop || (D[h].stopped = !0)
        }
        ;
        ...
        a.objectEach = function(a, f, h) {
            for (var l in a)
                a.hasOwnProperty(l) && f.call(h, a[l], l, a)
        }
        ;
        a.addEvent = function(n, f, h) {
            ...
            n.addEventListener ? n.addEventListener(f, h, !1) : n.attachEvent && (n.hcEventsIE || (n.hcEventsIE = {}),
            n.hcEventsIE[h.toString()] = l,
            n.attachEvent("on" + f, l));
            w[f] || (w[f] = []);
            w[f].push(h);
            return function() {
                a.removeEvent(n, f, h)
        ...
        a.removeEvent = function(n, f, h) {
            function l(a, d) {
                n.removeEventListener ? n.removeEventListener(a, d, !1) : n.attachEvent && (d = n.hcEventsIE[d.toString()],
                n.detachEvent("on" + a, d))
            }
            function w() {
                var d, C;
                n.nodeName && (f ? (d = {},
        ...
        a.fireEvent = function(n, f, h, l) {
            ...
            var t, e;
            h = h || {};
            if (G.createEvent && (n.dispatchEvent || n.fireEvent))
                w = G.createEvent("Events"),
                w.initEvent(f, !0, !0),
                a.extend(w, h),
                n.dispatchEvent ? n.dispatchEvent(w) : n.fireEvent(f, w);
            else if (w)
                for (w = w[f] || [],
                t = w.length,
                h.target || a.extend(h, {
                ...
                f = 0; f < t; f++)
                    (e = w[f]) && !1 === e.call(n, h) && h.preventDefault();
            l && !h.defaultPrevented && l(h)
        }
        ;
        a.animate = function(n, f, h) {
            var l, w = "", t, e, d;
            a.isObject(h) || (d = arguments,
            h = {
                duration: d[2],
                easing: d[3],
                complete: d[4]
            ...
            a.objectEach(f, function(d, C) {
                ...
                e = new a.Fx(n,h,C);
                t = null;
                "d" === C ? (e.paths = e.initPath(n, n.d, f.d),
                e.toD = f.d,
                l = 0,
                t = 1) : n.attr ? l = n.attr(C) : (l = parseFloat(a.getStyle(n, C)) || 0,
                "opacity" !== C && (w = "px"));
                t || (t = d);
        ...
        a.seriesType = function(n, f, h, l, w) {
            ...
            e[n] = a.extendClass(e[f] || function() {}
            , l);
        ...
        G && !G.defaultView && (a.getStyle = function(n, f) {
            ...
            if (n.style[f])
                return a.pInt(n.style[f]);
            "opacity" === f && (f = "filter");
            if (h)
                return n.style.zoom = 1,
                Math.max(n[h] - 2 * a.getStyle(n, "padding"), 0);
        ...
        a.Color.prototype = {
            ...
            init: function(f) {
                ...
                if ((this.input = f = this.names[f && f.toLowerCase ? f.toLowerCase() : ""] || f) && f.stops)
                    this.stops = G(f.stops, function(e) {
                        return new a.Color(e[1])
                    });
                else if (f && "#" === f[0] && (h = f.length,
                f = parseInt(f.substr(1), 16),
                7 === h ? l = [(f & 16711680) >> 16, (f & 65280) >> 8, f & 255, 1] : 4 === h && (l = [(f & 3840) >> 4 | (f & 3840) >> 8, (f & 240) >> 4 | f & 240, (f & 15) << 4 | f & 15, 1])),
                !l)
                    for (n = this.parsers.length; n-- && !l; )
                        t = this.parsers[n],
                        (h = t.regex.exec(f)) && (l = t.parse(h));
                this.rgba = l || []
            },
            get: function(a) {
                var f = this.input, l = this.rgba, n;
                this.stops ? (n = F(f),
                n.stops = [].concat(n.stops),
                D(this.stops, function(f, e) {
    ...
    (function(a) {
        ...
        D.prototype = {
            ...
            animate: function(v, g, b) {
                ...
                F(this, v, g)) : (this.attr(v, null, b),
                g.step && g.step.call(this));
                return this
            },
            colorGradient: function(v, g, b) {
                var r = this.renderer, c, k, p, d, Q, e, u, m, x, y, E = [], J;
                ...
                "radialGradient" === k && y && !t(p.gradientUnits) && (d = p,
                p = q(p, r.getRadialAttr(y, d), {
                    gradientUnits: "userSpaceOnUse"
                })),
                H(p, function(a, v) {
                    "id" !== v && E.push(v, a)
                ...
                E = E.join(","),
                Q[E] ? y = Q[E].attr("id") : (p.id = y = a.uniqueKey(),
                Q[E] = e = r.createElement(k).attr(p).add(r.defs),
                e.radAttr = d,
                e.stops = [],
                C(u, function(v) {
                    0 === v[1].indexOf("rgba") ? (c = a.color(v[1]),
                    m = c.get("rgb"),
                    x = c.get("a")) : (m = v[1],
                    x = 1);
            ...
            applyTextOutline: function(v) {
                ...
                if ((c = v[0]) && "none" !== c && a.svg) {
                    ...
                    for (q = v.length; q--; )
                        b = v[q],
                        "highcharts-text-outline" === b.getAttribute("class") && x(v, g.removeChild(b));
                    k = g.firstChild;
                    C(v, function(a, v) {
                        0 === v && (a.setAttribute("x", g.getAttribute("x")),
                        v = g.getAttribute("y"),
            ...
            attr: function(a, g, b, r) {
                var v, c = this.element, k, q = this, p, d;
                "string" === typeof a && void 0 !== g && (v = a,
                a = {},
                a[v] = g);
                "string" === typeof a ? q = (this[a + "Getter"] || this._defaultGetter).call(this, a, c) : (H(a, function(v, g) {
                    ...
                    p || (d = this[g + "Setter"] || this._defaultSetter,
                    d.call(this, v, g, c),
                    this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(g) && this.updateShadows(g, v, d))
                }, this),
            ...
            updateShadows: function(a, g, b) {
                for (var v = this.shadows, r = v.length; r--; )
                    b.call(v[r], "height" === a ? Math.max(g - (v[r].cutHeight || 0), 0) : "d" === a ? this.d : g, a, v[r])
            },
            ...
            removeClass: function(a) {
                n(this.element, "class", (n(this.element, "class") || "").replace(a, ""));
                return this
            },
            ...
            crisp: function(a, g) {
                ...
                a.width = Math.floor((a.width || v.width || 0) - 2 * r);
            ...
            css: function(a) {
                var v = this.styles, r = {}, c = this.element, k, q = "", p, d = !v, e = ["textOutline", "textOverflow", "width"];
                ...
                d && (v && (a = b(v, r)),
                k = this.textWidth = a && a.width && "auto" !== a.width && "text" === c.nodeName.toLowerCase() && g(a.width),
                this.styles = a,
            ...
            getBBox: function(a, g) {
                var v, r = this.renderer, c, k = this.element, q = this.styles, p, d = this.textStr, u, m = r.cache, Q = r.cacheKeys, y;
                g = K(g, this.rotation);
                c = g * e;
                p = q && q.fontSize;
                void 0 !== d && (y = d.toString(),
                -1 === y.indexOf("\x3c") && (y = y.replace(/[0-9]/g, "0")),
                y += ["", g || 0, p, q && q.width, q && q.textOverflow].join());
                y && !a && (v = m[y]);
                if (!v) {
                    if (k.namespaceURI === this.SVG_NS || r.forExport) {
                        try {
                            (u = this.fakeTS && function(a) {
                                C(k.querySelectorAll(".highcharts-text-outline"), function(v) {
                                    v.style.display = a
                                })
                            }
                            ) && u("none"),
                            v = k.getBBox ? b({}, k.getBBox()) : {
                                width: k.offsetWidth,
                    ...
                    r.isSVG && (a = v.width,
                    r = v.height,
                    q && "11px" === q.fontSize && 17 === Math.round(r) && (v.height = r = 14),
                    g && (v.width = Math.abs(r * Math.sin(c)) + Math.abs(a * Math.cos(c)),
                    v.height = Math.abs(r * Math.cos(c)) + Math.abs(a * Math.sin(c))));
                    if (y && 0 < v.height) {
                        for (; 250 < Q.length; )
                            delete m[Q.shift()];
                        m[y] || Q.push(y);
            ...
            add: function(a) {
                var v = this.renderer, g = this.element, b;
            ...
            shadow: function(a, g, b) {
                var v = [], r, c, k = this.element, q, p, d, e;
                if (!a)
                    this.destroyShadows();
                    ...
                    for (r = 1; r <= p; r++)
                        ...
                        b && (n(c, "height", Math.max(n(c, "height") - q, 0)),
                        c.cutHeight = q),
                        g ? g.element.appendChild(c) : k.parentNode.insertBefore(c, k),
                        v.push(c);
                    this.shadows = v
                }
                return this
            ...
            zIndexSetter: function(a, b) {
                var v = this.renderer, r = this.parentGroup, c = (r || v).element || v.box, k, q = this.element, p;
                k = this.added;
                var d;
                t(a) && (q.zIndex = a,
                a = +a,
                ...
                if (k) {
                    ...
                    b = c.childNodes;
                    for (d = 0; d < b.length && !p; d++)
                        r = b[d],
                        k = r.zIndex,
                        r !== q && (g(k) > a || !t(a) && t(k) || 0 > a && !t(k) && c !== v.box) && (c.insertBefore(q, r),
                        p = !0);
                    p || c.appendChild(q)
                }
                return p
        ...
        A.prototype = {
            ...
            init: function(a, g, b, r, c, q) {
                ...
                v = r.element;
                a.appendChild(v);
                -1 === a.innerHTML.indexOf("xmlns") && n(v, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = v;
                this.boxWrapper = r;
                this.alignedObjects = [];
                ...
                ,
                g(),
                this.unSubPixelFix = G(P, "resize", g))
            },
            getStyle: function(a) {
                return this.style = b({
            ...
            applyEllipsis: function(a, g, b, r) {
                var v = this.getSpanWidth(a, g), c = v > r, v = b, k, q = 0, p = b.length, d = function(a) {
                ...
                if (c) {
                    for (; q <= p; )
                        ...
                        q === p ? q = p + 1 : v > r ? p = k - 1 : q = k;
                    0 === p && d("")
                }
                return c
            },
            buildText: function(a) {
                var b = a.element, r = this, v = r.forExport, k = K(a.textStr, "").toString(), q = -1 !== k.indexOf("\x3c"), p = b.childNodes, d, e, u, y, x = n(b, "x"), E = a.styles, z = a.textWidth, f = E && E.lineHeight, H = E && E.textOutline, B = E && "ellipsis" === E.textOverflow, h = E && "nowrap" === E.whiteSpace, t = E && E.fontSize, R, w, M = p.length, E = z && !a.added && this.box, I = function(a) {
                    var v;
                ...
                if (R !== a.textCache) {
                    for (a.textCache = R; M--; )
                        b.removeChild(p[M]);
                    q || H || B || z || -1 !== k.indexOf(" ") ? (d = /<.*class="([^"]+)".*>/,
                    e = /<.*style="([^"]+)".*>/,
                    u = /<.*href="(http[^"]+)".*>/,
                    E && E.appendChild(b),
                    k = q ? k.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [k],
                    k = c(k, function(a) {
                        return "" !== a
                    }),
                    C(k, function(g, c) {
                        ...
                        C(k, function(g) {
                            if ("" !== g || 1 === k.length) {
                                var p = {}, E = m.createElementNS(r.SVG_NS, "tspan"), f, H;
                                d.test(g) && (f = g.match(d)[1],
                                n(E, "class", f));
                                e.test(g) && (H = g.match(e)[1].replace(/(;| |^)color([ :])/, "$1fill$2"),
                                n(E, "style", H));
                                u.test(g) && !v && (n(E, "onclick", 'location.href\x3d"' + g.match(u)[1] + '"'),
                                l(E, {
                                    cursor: "pointer"
                                }));
                                ...
                                if (" " !== g) {
                                    ...
                                    if (z) {
                                        ...
                                        var C = [], Q, t = I(E), R = a.rotation;
                                        for (B && (y = r.applyEllipsis(a, E, g, z)); !B && f && (p.length || C.length); )
                                            a.rotation = 0,
                                            Q = r.getSpanWidth(a, E),
                                            g = Q > z,
                                            void 0 === y && (y = g),
                                            g && 1 !== p.length ? (E.removeChild(E.firstChild),
                                            C.unshift(p.pop())) : (p = C,
                                            C = [],
                                            p.length && !h && (E = m.createElementNS(N, "tspan"),
                                            n(E, {
                                                dy: t,
                                                x: x
                                            }),
                                            ...
                                            b.appendChild(E)),
                                            Q > z && (z = Q)),
                                            p.length && E.appendChild(m.createTextNode(p.join(" ").replace(/- /g, "-")));
                                        a.rotation = R
                                    }
                                    q++
                                }
                    ...
                    E && E.removeChild(b),
                    H && a.applyTextOutline && a.applyTextOutline(H)) : b.appendChild(m.createTextNode(k.replace(/&lt;/g, "\x3c").replace(/&gt;/g, "\x3e")))
                }
            },
            ...
            symbol: function(a, g, r, c, k, p) {
                var v = this, q, d = /^url\((.*?)\)$/, e = d.test(a), E = !e && (this.symbols[a] ? a : "circle"), u = E && this.symbols[E], y = t(g) && u && u.call(this.symbols, Math.round(g), Math.round(r), c, k, p), x, z;
                u ? (q = this.path(y),
                q.attr("fill", "none"),
                b(q, {
                    symbolName: E,
                ...
                p && b(q, p)) : e && (x = a.match(d)[1],
                q = this.image(x),
                q.imgwidth = K(O[x] && O[x].width, p && p.width),
                q.imgheight = K(O[x] && O[x].height, p && p.height),
                z = function() {
                    q.attr({
                        width: q.width,
                        height: q.height
                ...
                C(["width", "height"], function(a) {
                    q[a + "Setter"] = function(a, g) {
                        ...
                        this[g] = a;
                        t(r) && (this.element && this.element.setAttribute(g, r),
                        this.alignByTranslate || (b[c] = ((this[g] || 0) - r) / 2,
                        this.attr(b)))
                    }
                }),
                t(g) && q.attr({
                ...
                q.isImg = !0,
                t(q.imgwidth) && t(q.imgheight) ? z() : (q.attr({
                    width: 0,
                    height: 0
                }),
                w("img", {
            ...
            symbols: {
                circle: function(a, g, b, r) {
                    return this.arc(a + b / 2, g + r / 2, b / 2, r / 2, {
                        start: 0,
                        end: 2 * Math.PI,
                        open: !1
                    })
                ...
                callout: function(a, g, b, r, c) {
                    ...
                    p && p > b ? c > g + q && c < g + r - q ? v.splice(13, 3, "L", a + b, c - 6, a + b + 6, c, a + b, c + 6, a + b, g + r - k) : v.splice(13, 3, "L", a + b, r / 2, p, c, a + b, r / 2, a + b, g + r - k) : p && 0 > p ? c > g + q && c < g + r - q ? v.splice(33, 3, "L", a, c + 6, a - 6, c, a, c - 6, a, g + k) : v.splice(33, 3, "L", a, r / 2, p, c, a, r / 2, a, g + k) : c && c > r && p > a + q && p < a + b - q ? v.splice(23, 3, "L", p + 6, g + r, p, g + r + 6, p - 6, g + r, a + k, g + r) : c && 0 > c && p > a + q && p < a + b - q && v.splice(3, 3, "L", p - 6, g, p, g - 6, p + 6, g, b - k, g);
                    return v
                }
            },
            ...
            text: function(a, g, b, r) {
                ...
                r || (a.xSetter = function(a, g, b) {
                    var r = b.getElementsByTagName("tspan"), c, k = b.getAttribute(g), q;
                    for (q = 0; q < r.length; q++)
                        c = r[q],
                        c.getAttribute(g) === k && c.setAttribute(g, a);
                    b.setAttribute(g, a)
                }
                );
                return a
            ...
            label: function(g, c, k, p, d, e, E, u, m) {
                var v = this, y = v.g("button" !== m && "label"), x = y.text = v.text("", 0, 0, E).attr({
                    zIndex: 1
                }), z, J, f = 0, H = 3, l = 0, B, h, n, R, w, M = {}, I, N, K = /^url\((.*?)\)$/.test(p), Q = K, U, T, O, P;
                ...
                T = function() {
                    ...
                    Q && (z || (y.box = z = v.symbols[p] || K ? v.symbol(p) : v.rect(),
                    z.addClass(("button" === m ? "" : "highcharts-label-box") + (m ? " highcharts-" + m + "-box" : "")),
                    z.add(y),
                    a = U(),
                    g.x = a,
                    g.y = (u ? -N : 0) + a),
                    g.width = Math.round(y.width),
                    g.height = Math.round(y.height),
                    z.attr(b(g, M)),
                    M = {})
                }
                ;
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    ...
                    if ("SPAN" === b.tagName) {
                        ...
                        q !== this.cTT && (E = a.fontMetrics(b.style.fontSize).b,
                        F(p) && this.setSpanRotation(p, k, E),
                        G(b, {
                            width: "",
                            whiteSpace: l || "nowrap"
                        }),
    ...
    (function(a) {
        var D, A, G = a.createElement, F = a.css, n = a.defined, f = a.deg2rad, h = a.discardElement, l = a.doc, w = a.each, t = a.erase, e = a.extend;
        D = a.extendClass;
        var d = a.isArray
          , m = a.isNumber
          , C = a.isObject
        ...
        a.svg || (A = {
            ...
            getSpanCorrection: function(a, b, c, d, e) {
                var k = d ? Math.cos(d * f) : 1, p = d ? Math.sin(d * f) : 0, m = x(this.elemHeight, this.element.offsetHeight), u;
                this.xCorr = 0 > k && -a;
                this.yCorr = 0 > p && -m;
                u = 0 > k * p;
                this.xCorr += p * b * (u ? 1 - c : c);
                this.yCorr -= k * b * (d ? u ? c : 1 - c : 1);
                e && "left" !== e && (this.xCorr -= a * c * (0 > k ? -1 : 1),
                d && (this.yCorr -= m * c * (0 > p ? -1 : 1)),
                F(this.element, {
                    textAlign: e
                }))
            },
            pathToVML: function(a) {
                for (var b = a.length, c = []; b--; )
                    m(a[b]) ? c[b] = Math.round(10 * a[b]) - 5 : "Z" === a[b] ? c[b] = "x" : (c[b] = a[b],
            ...
            cutOffPath: function(a, b) {
                ...
                k = a.length;
                if (9 === k || 11 === k)
                    a[k - 4] = a[k - 2] = c(a[k - 2]) - 10 * b;
                return a.join(" ")
            },
            shadow: function(a, b, d) {
                var k = [], p, q = this.element, e = this.renderer, m, u = q.style, g, r = q.path, f, J, E, l;
                ...
                if (a) {
                    ...
                    for (p = 1; 3 >= p; p++)
                        f = 2 * E + 1 - 2 * p,
                        d && (J = this.cutOffPath(r.value, f + .5)),
                        g = ['\x3cshape isShadow\x3d"true" strokeweight\x3d"', f, '" filled\x3d"false" path\x3d"', J, '" coordsize\x3d"10 10" style\x3d"', q.style.cssText, '" /\x3e'],
                        m = G(e.prepVML(g), null, {
                            left: c(u.left) + x(a.offsetX, 1),
                            top: c(u.top) + x(a.offsetY, 1)
                        }),
                        d && (m.cutOff = f + 1),
                        g = ['\x3cstroke color\x3d"', a.color || "#000000", '" opacity\x3d"', l * p, '"/\x3e'],
                        G(e.prepVML(g), null, null, m),
                        b ? b.element.appendChild(m) : q.parentNode.insertBefore(m, q),
                        k.push(m);
                    this.shadows = k
                }
                return this
            ...
            dSetter: function(a, b, c) {
                ...
                if (k)
                    for (c = k.length; c--; )
                        k[c].path = k[c].cutOff ? this.cutOffPath(a, k[c].cutOff) : a;
                this.setAttr(b, a)
            },
            fillSetter: function(a, b, c) {
                var k = c.nodeName;
                "SPAN" === k ? c.style.color = a : "IMG" !== k && (c.filled = "none" !== a,
        ...
        A = {
            ...
            color: function(b, c, d, e) {
                var k = this, q, p = /^rgba/, m, u, g = "none";
                b && b.linearGradient ? u = "gradient" : b && b.radialGradient && (u = "pattern");
                if (u) {
                    var r, x, J = b.linearGradient || b.radialGradient, f, z, l, v, B, E = "";
                    b = b.stops;
                    var C, h = [], t = function() {
                    ...
                    if ("fill" === d)
                        if ("gradient" === u)
                            ...
                            f = J.x2 || J[2] || 0,
                            J = J.y2 || J[3] || 0,
                            E = 'angle\x3d"' + (90 - 180 * Math.atan((J - b) / (f - d)) / Math.PI) + '"',
                            t();
                        else {
                            var g = J.r, n = 2 * g, I = 2 * g, A = J.cx, D = J.cy, F = c.radialReference, L, g = function() {
                                F && (L = e.getBBox(),
                                A += (F[0] - L.x) / L.width - .5,
                                D += (F[1] - L.y) / L.height - .5,
                                n *= F[2] / L.width,
                                I *= F[2] / L.height);
                                E = 'src\x3d"' + a.getOptions().global.VMLRadialGradientURL + '" size\x3d"' + n + "," + I + '" origin\x3d"0.5,0.5" position\x3d"' + A + "," + D + '" color2\x3d"' + B + '" ';
                                t()
                            };
                            e.added ? g() : e.onAdd = g;
                            g = v
                    ...
                    p.test(b) && "IMG" !== c.tagName ? (q = a.color(b),
                    e[d + "-opacitySetter"](q.get("a"), d, c),
                    g = q.get("rgb")) : (g = c.getElementsByTagName(d),
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    return B.prototype.symbols[n(e) && e.r ? "callout" : "square"].call(0, a, b, c, d, e)
                }
            }
        },
    ...
    (function(a) {
        ...
        function A() {
            var f = a.defaultOptions.global, t, e = f.useUTC, d = e ? "getUTC" : "get", m = e ? "setUTC" : "set";
            a.Date = t = f.Date || l.Date;
            t.hcTimezoneOffset = e && f.timezoneOffset;
            t.hcGetTimezoneOffset = D();
            t.hcMakeTime = function(a, b, d, c, m, f) {
                var u;
                e ? (u = t.UTC.apply(0, arguments),
                u += n(u)) : u = (new t(a,b,h(d, 1),h(c, 0),h(m, 0),h(f, 0))).getTime();
                return u
            }
            ;
    ...
    (function(a) {
        ...
        a.Tick.prototype = {
            addLabel: function() {
                var a = this.axis, h = a.options, t = a.chart, e = a.categories, d = a.names, m = this.pos, C = h.labels, b = a.tickPositions, x = m === b[0], c = m === b[b.length - 1], d = e ? f(e[m], d[m], m) : m, e = this.label, b = b.info, u;
                ...
                A(e) ? e && e.attr({
                    text: h
                }) : (this.labelLength = (this.label = e = A(h) && C.enabled ? t.renderer.text(h, 0, 0, C.useHTML).css(n(C.style)).add(a.labelGroup) : null) && e.getBBox().width,
                this.rotation = 0)
            },
            ...
            handleOverflow: function(a) {
                var l = this.axis, t = a.x, e = l.chart.chartWidth, d = l.chart.spacing, m = f(l.labelLeft, Math.min(l.pos, d[3])), d = f(l.labelRight, Math.max(l.pos + l.len, e - d[1])), C = this.label, b = this.rotation, x = {
                    left: 0,
                    center: .5,
                    right: 1
                }[l.labelAlign], c = C.getBBox().width, u = l.getSlotWidth(), B = u, n = 1, k, E = {};
                if (b)
                    0 > b && t - x * c < m ? k = Math.round(t / Math.cos(b * h) - m) : 0 < b && t + x * c > d && (k = Math.round((e - t) / Math.cos(b * h)));
                else if (e = t + (1 - x) * c,
                t - x * c < m ? B = a.x + B * (1 - x) - m : e > d && (B = d - a.x + B * x,
                n = -1),
                B = Math.min(u, B),
                B < u && "center" === l.labelAlign && (a.x += n * (u - B - x * (u - Math.min(c, B)))),
                c > B || l.autoRotation && (C.styles || {}).width)
                    k = B;
                k && (E.width = k,
                (l.options.labels.style || {}).textOverflow || (E.textOverflow = "ellipsis"),
                C.css(E))
            },
            ...
            getLabelPosition: function(a, f, n, e, d, m, C, b) {
                var x = this.axis
                  ...
                  , k = d.y;
                A(k) || (k = 0 === x.side ? n.rotation ? -8 : -n.getBBox().height : 2 === x.side ? t.y + 8 : Math.cos(n.rotation * h) * (t.y - n.getBBox(!1, 0).height / 2));
            ...
            renderGridLine: function(a, f, h) {
                ...
                x || (l.zIndex = 1),
                a && (l.opacity = 0),
                this.gridLine = m = u.path().attr(l).addClass("highcharts-" + (x ? x + "-" : "") + "grid-line").add(e.gridGroup));
                if (!a && m && (a = e.getPlotLinePath(b + c, m.strokeWidth() * h, a, !0)))
            ...
            renderMark: function(a, h, n) {
                ...
                var t = f(d[b + "Width"], !l && e.isXAxis ? 1 : 0)
                  , d = d[b + "Color"];
                x && (e.opposite && (x[0] = -x[0]),
                u && (this.mark = c = m.path().addClass("highcharts-" + (l ? l + "-" : "") + "tick").add(e.axisGroup),
                c.attr({
                    stroke: d,
                    "stroke-width": t
                })),
            ...
            renderLabel: function(a, h, n, e) {
                var d = this.axis
                  ...
                  , t = a.x;
                a = a.y;
                b && F(t) && (b.xy = a = this.getLabelPosition(t, a, b, m, x, u, e, c),
                this.isFirst && !this.isLast && !f(l.showFirstLabel, 1) || this.isLast && !this.isFirst && !f(l.showLastLabel, 1) ? B = !1 : !m || d.isRadial || x.step || x.rotation || h || 0 === n || this.handleOverflow(a),
                c && e % c && (B = !1),
                B && F(a.y) ? (a.opacity = n,
                b[this.isNew ? "attr" : "animate"](a)) : b.attr("y", -9999),
                this.isNew = !1)
            },
    ...
    var S = function(a) {
        ...
        a.extend(K.prototype, {
            ...
            init: function(a, b) {
                ...
                b = r.options.events;
                -1 === c(r, a.axes) && (g ? a.axes.splice(a.xAxis.length, 0, r) : a.axes.push(r),
                a[r.coll].push(r));
                r.series = r.series || [];
                ...
                r.isLog && (r.val2lin = r.log2lin,
                r.lin2val = r.lin2log)
            },
            setOptions: function(a) {
                this.options = k(this.defaultOptions, "yAxis" === this.coll && this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], k(h[this.coll], a))
            },
            defaultLabelFormatter: function() {
                var b = this.axis, c = this.value, d = b.categories, q = this.dateTimeLabelFormat, k = h.lang, e = k.numericSymbols, k = k.numericSymbolMagnitude || 1E3, p = e && e.length, v, m = b.options.labels.format, b = b.isLog ? Math.abs(c) : b.tickInterval;
                if (m)
                    v = C(m, this);
                else if (d)
                    v = c;
                    ...
                    for (; p-- && void 0 === v; )
                        d = Math.pow(k, p + 1),
                        b >= d && 0 === 10 * c % d && null !== e[p] && 0 !== c && (v = a.numberFormat(c / d, -1) + e[p]);
            ...
            getSeriesExtremes: function() {
                ...
                e(a.series, function(g) {
                    if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                        var c = g.options, r = c.threshold, d;
                        a.hasVisibleSeries = !0;
                        a.positiveValuesOnly && 0 >= r && (r = null);
                        if (a.isXAxis)
                            c = g.xData,
                            c.length && (g = F(c),
                            B(g) || g instanceof Date || (c = x(c, function(a) {
                                return B(a)
                            }),
                            g = F(c)),
                            a.dataMin = Math.min(z(a.dataMin, c[0]), g),
                            a.dataMax = Math.max(z(a.dataMax, c[0]), G(c)));
                        else if (g.getExtremes(),
                        d = g.dataMax,
                        g = g.dataMin,
                        l(g) && l(d) && (a.dataMin = Math.min(z(a.dataMin, g), g),
            ...
            translate: function(a, b, c, d, q, k) {
                ...
                e -= r * (g.sector || g.len));
                b ? (a = (a * r + e - m) / p + d,
                q && (a = g.lin2val(a))) : (q && (a = g.val2lin(a)),
                a = r * (a - d) * p + e + r * m + (B(k) ? p * k : 0));
                return a
            },
            ...
            getPlotLinePath: function(a, b, c, d, q) {
                var g = this.chart, r = this.left, k = this.top, e, p, m = c && g.oldChartHeight || g.chartHeight, u = c && g.oldChartWidth || g.chartWidth, y;
                e = this.transB;
                var x = function(a, b, g) {
                    if (a < b || a > g)
                        d ? a = Math.min(Math.max(b, a), g) : y = !0;
                    return a
                };
                ...
                B(q) ? this.horiz ? (e = k,
                p = m - this.bottom,
                a = c = x(a, r, r + this.width)) : (a = r,
                c = u - this.right,
                e = p = x(e, k, k + this.height)) : y = !0;
                return y && !d ? null : g.renderer.crispLine(["M", a, e, "L", c, p], b || 1)
            },
            ...
            getMinorTickPositions: function() {
                ...
                if (v && v / d < a.len / 3)
                    if (a.isLog)
                        e(this.paddedTicks, function(b, g, c) {
                            g && q.push.apply(q, a.getLogTickPositions(d, c[g - 1], c[g], !0))
                        });
                    else if (a.isDatetimeAxis && "auto" === b.minorTickInterval)
                        q = q.concat(a.getTimeTicks(a.normalizeTimeTickInterval(d), p, k, b.startOfWeek));
                    else
                        for (b = p + (c[0] - p) % d; b <= k && b !== q[0]; b += d)
                            q.push(b);
                0 !== q.length && a.trimTicks(q);
                return q
            },
            adjustForMinRange: function() {
                var a = this.options, b = this.min, c = this.max, d, q = this.dataMax - this.dataMin >= this.minRange, k, p, v, m, u, y;
                ...
                c - b < this.minRange && (y = this.minRange,
                d = (y - c + b) / 2,
                d = [b - d, z(a.min, b - d)],
                q && (d[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin),
                b = G(d),
                c = [b + y, z(a.max, b + y)],
            ...
            nameToX: function(a) {
                var b = u(this.categories), g = b ? this.categories : this.names, d = a.options.x, q;
                a.series.requireSorting = !1;
                l(d) || (d = !1 === this.options.uniqueNames ? a.series.autoIncrement() : c(a.name, g));
                -1 === d ? b || (q = g.length) : q = d;
            ...
            updateNames: function() {
                ...
                e(this.series || [], function(b) {
                    ...
                    e(b.points, function(g, c) {
                        var r;
                        g.options && (r = a.nameToX(g),
                        void 0 !== r && r !== g.x && (g.x = r,
                        b.xData[c] = r))
                    })
                }))
            },
            setAxisTranslation: function(a) {
                var b = this, g = b.max - b.min, c = b.axisPointRange || 0, d, q = 0, k = 0, p = b.linkedParent, m = !!b.categories, u = b.transA, y = b.isXAxis;
                if (y || m || c)
                    d = b.getClosest(),
                    p ? (q = p.minPointOffset,
                    k = p.pointRangePadding) : e(b.series, function(a) {
                        var g = m ? 1 : y ? z(a.options.pointRange, d, 0) : b.axisPointRange || 0;
                        a = a.options.pointPlacement;
                        c = Math.max(c, g);
                        b.single || (q = Math.max(q, I(a) ? 0 : g / 2),
                        k = Math.max(k, "on" === a ? 0 : g))
                    }),
                    p = b.ordinalSlope && d ? b.ordinalSlope / d : 1,
                    b.minPointOffset = q *= p,
                    b.pointRangePadding = k *= p,
                    b.pointRange = Math.min(c, g),
                    y && (b.closestPointRange = d);
                a && (b.oldTransA = u);
            ...
            setTickInterval: function(g) {
                var c = this, d = c.chart, q = c.options, k = c.isLog, p = c.log2lin, u = c.isDatetimeAxis, v = c.isXAxis, y = c.isLinked, x = q.maxPadding, H = q.minPadding, h = q.tickInterval, n = q.tickPixelInterval, C = c.categories, t = c.threshold, I = c.softThreshold, K, w, M, A;
                u || C || y || this.getTickAmount();
                M = z(c.userMin, q.min);
                A = z(c.userMax, q.max);
                y ? (c.linkedParent = d[c.coll][q.linkedTo],
                d = c.linkedParent.getExtremes(),
                c.min = z(d.min, d.dataMin),
                c.max = z(d.max, d.dataMax),
                q.type !== c.linkedParent.options.type && a.error(11, 1)) : (!I && l(t) && (c.dataMin >= t ? (K = t,
                H = 0) : c.dataMax <= t && (w = t,
                x = 0)),
                c.min = z(M, K, c.dataMin),
                c.max = z(A, w, c.dataMax));
                k && (c.positiveValuesOnly && !g && 0 >= Math.min(c.min, z(c.dataMin, c.min)) && a.error(10, 1),
                c.min = f(p(c.min), 15),
                c.max = f(p(c.max), 15));
                c.range && l(c.max) && (c.userMin = c.min = M = Math.max(c.min, c.minFromRange()),
                c.userMax = A = c.max,
                c.range = null);
                m(c, "foundExtremes");
                c.beforePadding && c.beforePadding();
                c.adjustForMinRange();
                !(C || c.axisPointRange || c.usePercentage || y) && l(c.min) && l(c.max) && (p = c.max - c.min) && (!l(M) && H && (c.min -= p * H),
                !l(A) && x && (c.max += p * x));
                B(q.softMin) && (c.min = Math.min(c.min, q.softMin));
                B(q.softMax) && (c.max = Math.max(c.max, q.softMax));
                B(q.floor) && (c.min = Math.max(c.min, q.floor));
                B(q.ceiling) && (c.max = Math.min(c.max, q.ceiling));
                I && l(c.dataMin) && (t = t || 0,
                !l(M) && c.min < t && c.dataMin >= t ? c.min = t : !l(A) && c.max > t && c.dataMax <= t && (c.max = t));
            ...
            setTickPositions: function() {
                var a = this.options, b, c = a.tickPositions, d = a.tickPositioner, q = a.startOnTick, k = a.endOnTick;
                ...
                this.isLinked || (this.single && (this.min -= .5,
                this.max += .5),
            ...
            alignToOthers: function() {
                ...
                !1 === this.chart.options.chart.alignTicks || !1 === c.alignTicks || this.isLog || e(this.chart[this.coll], function(c) {
                    var g = c.options
            ...
            zoom: function(a, b) {
                ...
                if (a !== this.min || b !== this.max)
                    this.allowZoomOutside || (l(c) && (a < q && (a = q),
                    a > d && (a = d)),
                    l(g) && (b < q && (b = q),
                    b > d && (b = d))),
            ...
            unsquish: function() {
                var a = this.options.labels, b = this.horiz, c = this.tickInterval, d = c, q = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / c), k, p = a.rotation, v = this.labelMetrics(), m, u = Number.MAX_VALUE, y, x = function(a) {
                    a /= q || 1;
                    a = 1 < a ? Math.ceil(a) : 1;
                    return a * c
                };
            ...
            getSlotWidth: function() {
                var a = this.chart
                  ...
                  , q = a.margin[3];
                return b && 2 > (c.step || 0) && !c.rotation && (this.staggerLines || 1) * this.len / d || !b && (q && q - a.spacing[3] || .33 * a.chartWidth)
            },
            renderUnsquish: function() {
                var a = this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, q = this.options.labels, p = this.horiz, m = this.getSlotWidth(), v = Math.max(1, Math.round(m - 2 * (q.padding || 5))), u = {}, y = this.labelMetrics(), x = q.style && q.style.textOverflow, f, H = 0, h, l;
                ...
                if (this.autoRotation)
                    H > v && H > y.h ? u.rotation = this.labelRotation : this.labelRotation = 0;
                else if (m && (f = {
                    width: v + "px"
                },
                !x))
                    for (f.textOverflow = "clip",
                    h = c.length; !p && h--; )
                        if (l = c[h],
                        v = d[l].label)
                            v.styles && "ellipsis" === v.styles.textOverflow ? v.css({
                                textOverflow: "clip"
                ...
                if (this.labelAlign = q.align || this.autoLabelAlign(this.labelRotation))
                    u.align = this.labelAlign;
                e(c, function(a) {
                    var b = (a = d[a]) && a.label;
                    b && (b.attr(u),
                    f && b.css(k(f, b.specCss)),
                    delete b.specCss,
            ...
            addTitle: function(a) {
                var b = this.chart.renderer, c = this.horiz, g = this.opposite, d = this.options.title, q;
                ...
                this.axisTitle = b.text(d.text, 0, 0, d.useHTML).attr({
                    zIndex: 7,
            ...
            getOffset: function() {
                var a = this, b = a.chart, c = b.renderer, d = a.options, q = a.tickPositions, k = a.ticks, m = a.horiz, v = a.side, u = b.inverted ? [1, 0, 3, 2][v] : v, y, x, f = 0, H, h = 0, B = d.title, n = d.labels, E = 0, C = b.axisOffset, b = b.clipOffset, t = [-1, 1, 1, -1][v], I = d.className, K = a.axisParent, w = this.tickSize("tick");
                y = a.hasData();
                a.showAxis = x = y || z(d.showEmpty, !0);
                a.staggerLines = a.horiz && n.staggerLines;
                a.axisGroup || (a.gridGroup = c.g("grid").attr({
                    zIndex: d.gridZIndex || 1
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (I || "")).add(K),
                a.axisGroup = c.g("axis").attr({
                    zIndex: d.zIndex || 2
                }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (I || "")).add(K),
                ...
                a.labelOffset = E * (a.opposite ? -1 : 1))) : p(k, function(a, b) {
                    a.destroy();
                    delete k[b]
                });
                B && B.text && !1 !== B.enabled && (a.addTitle(x),
                x && !1 !== B.reserveSpace && (a.titleOffset = f = a.axisTitle.getBBox()[m ? "height" : "width"],
                H = B.offset,
                h = l(H) ? 0 : z(B.margin, m ? 5 : 10)));
                a.renderLine();
            ...
            renderTick: function(a, b) {
                ...
                if (!c || a >= this.min && a <= this.max)
                    ...
                    d && g[a].isNew && g[a].render(b, !0, .1),
                    g[a].render(b)
            },
            render: function() {
                var b = this, c = b.chart, d = b.options, q = b.isLog, k = b.lin2log, m = b.isLinked, u = b.tickPositions, v = b.axisTitle, x = b.ticks, f = b.minorTicks, h = b.alternateBands, l = d.stackLabels, B = d.alternateGridColor, z = b.tickmarkOffset, n = b.axisLine, E = b.showAxis, C = A(c.renderer.globalAnimation), t, I;
                ...
                if (b.hasData() || m)
                    ...
                    z && (0 === b.min || b.single) && (x[-1] || (x[-1] = new H(b,-1,null,!0)),
                    x[-1].render(-1))),
                    B && e(u, function(g, d) {
                        I = void 0 !== u[d + 1] ? u[d + 1] + z : b.max - z;
                        0 === d % 2 && g < b.max && I <= b.max + (c.polar ? -z : z) && (h[g] || (h[g] = new a.PlotLineOrBand(b)),
                        t = g + z,
                        h[g].options = {
                            from: q ? k(t) : t,
                            to: q ? k(I) : I,
                ...
                e([x, f, h], function(a) {
                    ...
                    y(function() {
                        for (b = g.length; b--; )
                            a[g[b]] && !a[g[b]].isActive && (a[g[b]].destroy(),
                            delete a[g[b]])
                ...
                n.isPlaced = !0,
                n[E ? "show" : "hide"](!0));
                v && E && (v[v.isNew ? "attr" : "animate"](b.getTitlePosition()),
                v.isNew = !1);
            ...
            destroy: function(a) {
                var b = this, g = b.stacks, d = b.plotLinesAndBands, q;
                a || M(b);
                p(g, function(a, b) {
                    t(a);
                    g[b] = null
                ...
                for (q in b.plotLinesAndBandsGroups)
                    b.plotLinesAndBandsGroups[q] = b.plotLinesAndBandsGroups[q].destroy();
                p(b, function(a, g) {
                    -1 === c(g, b.keepProps) && delete b[g]
                })
            },
            drawCrosshair: function(a, b) {
                var c, d = this.crosshair, g = z(d.snap, !0), q, k = this.cross;
                a || (a = this.cross && this.cross.e);
                this.crosshair && !1 !== (l(b) || !g) ? (g ? l(b) && (q = this.isXAxis ? b.plotX : this.len - b.plotY) : q = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos),
                l(q) && (c = this.getPlotLinePath(b && (this.isXAxis ? b.x : z(b.stackY, b.y)), null, null, null, q) || null),
                l(c) ? (b = this.categories && !this.isRadial,
                k || (this.cross = k = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (b ? "category " : "thin ") + d.className).attr({
                    zIndex: z(d.zIndex, 2)
                }).add(),
                k.attr({
    ...
    (function(a) {
        ...
        D.prototype.getTimeTicks = function(a, l, b, x) {
            var c = [], m = {}, B = F.global.useUTC, t, k = new A(l - Math.max(w(l), w(b))), E = A.hcMakeTime, p = a.unitRange, z = a.count, C;
            if (n(l)) {
                k[A.hcSetMilliseconds](p >= d.second ? 0 : z * Math.floor(k.getMilliseconds() / z));
                if (p >= d.second)
                    k[A.hcSetSeconds](p >= d.minute ? 0 : z * Math.floor(k.getSeconds() / z));
                if (p >= d.minute)
                    k[A.hcSetMinutes](p >= d.hour ? 0 : z * Math.floor(k[A.hcGetMinutes]() / z));
                if (p >= d.hour)
                    k[A.hcSetHours](p >= d.day ? 0 : z * Math.floor(k[A.hcGetHours]() / z));
                if (p >= d.day)
                    k[A.hcSetDate](p >= d.month ? 1 : z * Math.floor(k[A.hcGetDate]() / z));
                p >= d.month && (k[A.hcSetMonth](p >= d.year ? 0 : z * Math.floor(k[A.hcGetMonth]() / z)),
                t = k[A.hcGetFullYear]());
                if (p >= d.year)
                    k[A.hcSetFullYear](t - t % z);
                if (p === d.week)
                    k[A.hcSetDate](k[A.hcGetDate]() - k[A.hcGetDay]() + e(x, 1));
                t = k[A.hcGetFullYear]();
                x = k[A.hcGetMonth]();
                var q = k[A.hcGetDate]()
                  , y = k[A.hcGetHours]();
                if (A.hcTimezoneOffset || A.hcGetTimezoneOffset)
                    C = (!B || !!A.hcGetTimezoneOffset) && (b - l > 4 * d.month || w(l) !== w(b)),
                    k = k.getTime(),
                    k = new A(k + w(k));
                B = k.getTime();
                for (l = 1; B < b; )
                    c.push(B),
                    B = p === d.year ? E(t + l * z, 0) : p === d.month ? E(t, x + l * z) : !C || p !== d.day && p !== d.week ? C && p === d.hour ? E(t, x, q, y + l * z) : B + p * z : E(t, x, q + l * z * (p === d.day ? 1 : 7)),
                    l++;
                c.push(B);
        ...
        D.prototype.normalizeTimeTickInterval = function(a, e) {
            var b = e || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]];
            e = b[b.length - 1];
            var m = d[e[0]], c = e[1], u;
            for (u = 0; u < b.length && !(e = b[u],
            m = d[e[0]],
            c = e[1],
            b[u + 1] && a <= (m * c[c.length - 1] + d[b[u + 1][0]]) / 2); u++)
                ;
    ...
    (function(a) {
        ...
        D.prototype.getLogTickPositions = function(a, h, l, w) {
            ...
            if (.5 <= a)
                a = Math.round(a),
                C = this.getLinearTickPositions(a, h, l);
            else if (.08 <= a)
                for (var e = Math.floor(h), b, x, c, u, B, f = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; e < l + 1 && !B; e++)
                    for (x = f.length,
                    b = 0; b < x && !B; b++)
                        c = m(d(e) * f[b]),
                        c > h && (!w || u <= l) && void 0 !== u && C.push(u),
                        u > l && (B = !0),
                        u = c;
            else
                h = d(h),
                l = d(l),
                a = f[w ? "minorTickInterval" : "tickInterval"],
                a = n("auto" === a ? null : a, this._minorAutoInterval, f.tickPixelInterval / (w ? 5 : 1) * (l - h) / ((w ? e / this.tickPositions.length : e) || 1)),
                a = F(a, null, A(a)),
                C = G(this.getLinearTickPositions(a, h, l), m),
    ...
    (function(a, D) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                m.dashStyle && (p.dashstyle = m.dashStyle)) : B && (z && (p.fill = z),
                m.borderWidth && (p.stroke = m.borderColor,
                p["stroke-width"] = m.borderWidth));
                y.zIndex = M;
                K += "-" + M;
                (z = e.plotLinesAndBandsGroups[K]) || (e.plotLinesAndBandsGroups[K] = z = H.g("plot-" + K).attr(y).add());
                E && (f.svgElem = k = H.path().attr(p).add(z));
                if (n)
                    p = e.getPlotLinePath(u, k.strokeWidth());
                else if (B)
                    p = e.getPlotBandPath(c, x, m);
                else
                    return;
                E && p && p.length ? (k.attr({
                    d: p
                ...
                this.renderLabel(h, p, B, M)) : b && b.hide();
                return f
            },
            renderLabel: function(a, e, d, m) {
                ...
                f.zIndex = m,
                this.label = f = b.text(a.text, 0, 0, a.useHTML).attr(f).add(),
                f.css(a.style));
                m = [e[1], e[4], d ? e[6] : e[1]];
                e = [e[2], e[5], d ? e[7] : e[2]];
                d = G(m);
        ...
        a.extend(D.prototype, {
            getPlotBandPath: function(a, e) {
                ...
                m && d ? (a && (m.flat = m.toString() === d.toString(),
                b = 0),
                m.push(f && d[4] === m[4] ? d[4] + b : d[4], f || d[5] !== m[5] ? d[5] : d[5] + b, f && d[1] === m[1] ? d[1] + b : d[1], f || d[2] !== m[2] ? d[2] : d[2] + b)) : m = null;
                return m
            },
            ...
            removePlotBandOrLine: function(a) {
                for (var e = this.plotLinesAndBands, d = this.options, m = this.userOptions, l = e.length; l--; )
                    e[l].id === a && e[l].destroy();
    ...
    (function(a) {
        ...
        a.Tooltip.prototype = {
            ...
            move: function(a, e, f, b) {
                var d = this
                  , c = d.now
                  , u = !1 !== d.options.animation && !d.isHidden && (1 < Math.abs(a - c.x) || 1 < Math.abs(e - c.y))
            ...
            getAnchor: function(a, e) {
                var d, b = this.chart, m = b.inverted, c = b.plotTop, u = b.plotLeft, h = 0, l = 0, k, n;
                a = w(a);
                d = a[0].tooltipPos;
                this.followPointer && e && (void 0 === e.chartX && (e = b.pointer.normalize(e)),
                d = [e.chartX - b.plotLeft, e.chartY - c]);
                d || (A(a, function(a) {
                    k = a.series.yAxis;
                    n = a.series.xAxis;
                ...
                h /= a.length,
                l /= a.length,
                d = [m ? b.plotWidth - l : h, this.shared && !m && 1 < a.length && e ? e.chartY - c : m ? b.plotHeight - h : l]);
                return f(d, Math.round)
            },
            getPosition: function(a, e, f) {
                var b = this.chart, d = this.distance, c = {}, u = f.h || 0, m, h = ["y", b.chartHeight, e, f.plotY + b.plotTop, b.plotTop, b.plotTop + b.plotHeight], k = ["x", b.chartWidth, a, f.plotX + b.plotLeft, b.plotLeft, b.plotLeft + b.plotWidth], n = !this.followPointer && l(f.ttBelow, !b.inverted === !!f.negative), p = function(a, b, q, g, k, e) {
                    var p = q < g - d
                      , m = g + d + q < b
                      , y = g - d - q;
                    g += d;
                    if (n && m)
                        ...
                        c[a] = Math.min(e - q, 0 > y - u ? y : y - u);
                    else if (m)
                        c[a] = Math.max(k, g + u + q > b ? g : g + u);
                    else
                        return !1
                }, z = function(a, b, q, g) {
                    var k;
                    g < d || g > b - d ? k = !1 : c[a] = g < q / 2 ? 1 : g > b - q / 2 ? b - q - 2 : g - q / 2;
                    return k
                }, t = function(a) {
                    var b = h;
                    h = k;
                    ...
                    !1 !== p.apply(0, h) ? !1 !== z.apply(0, k) || m || (t(!0),
                    q()) : m ? c.x = c.y = 0 : (t(!0),
                    q())
                };
            ...
            refresh: function(a, e) {
                var d, b = this.options, m, c = a, u, f = {}, h = [];
                ...
                !1 === f ? this.hide() : (d = this.getLabel(),
                this.isHidden && d.attr({
                    opacity: 1
                }).show(),
                this.split ? this.renderSplit(f, a) : (d.attr({
                    text: f && f.join ? f.join("") : f
                }),
                d.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + l(c.colorIndex, k.colorIndex)),
                d.attr({
            ...
            renderSplit: function(d, e) {
                var f = this, b = [], m = this.chart, c = m.renderer, u = !0, h = this.options, n, k = this.getLabel();
                A(d.slice(0, e.length + 1), function(a, d) {
                    ...
                    d.isHeader ? (n = a.height,
                    q = Math.max(0, Math.min(d.plotX + m.plotLeft - q / 2, m.chartWidth - q))) : q = d.plotX + m.plotLeft - l(h.distance, 16) - q;
                    0 > q && (u = !1);
            ...
            getDateFormat: function(a, f, h, b) {
                ...
                for (u in e) {
                    ...
                    if (m[u] && d.substr(m[u]) !== "01-01 00:00:00.000".substr(m[u]))
                        break;
                    "week" !== u && (l = u)
                }
                u && (c = b[u]);
            ...
            tooltipFooterHeaderFormatter: function(a, e) {
                ...
                u && f && (d = d.replace("{point.key}", "{point.key:" + f + "}"));
                return F(d, {
                    point: a,
                    series: e
                })
    ...
    (function(a) {
        ...
        a.Pointer.prototype = {
            init: function(a, e) {
                ...
                this.pinchDown = [];
                this.lastValidTouch = {};
                b && e.tooltip.enabled && (a.tooltip = new b(a,e.tooltip),
                this.followTouchMove = d(e.tooltip.followTouchMove, !0));
                this.setDOMEvents()
            },
            ...
            getKDPoints: function(a, b, e) {
                ...
                if (b && c[0] && !c[0].series.noSharedTooltip)
                    for (a = c.length; a--; )
                        (c[a].x !== c[0].x || c[a].series.noSharedTooltip) && c.splice(a, 1);
                return c
            },
            ...
            getHoverData: function(b, e, f, m, k, x) {
                ...
                0 === h.length && (h = [c])) : h = [c] : u && !u.stickyTracking ? (k || (f = [u]),
                h = this.getKDPoints(f, k, x),
                c = a.find(h, function(a) {
                    return a.series === u
                })) : (b = a.grep(f, function(a) {
                    return a.stickyTracking
                }),
                h = this.getKDPoints(b, k, x),
                u = (c = h[0]) && c.series,
                k && (h = this.getKDPoints(f, k, x)));
                h.sort(function(a, b) {
            ...
            runPointActions: function(b, e) {
                ...
                e = this.getHoverData(m, p, c.series, !!e || p && p.directTouch, k, b);
                ...
                if (m && (m !== c.hoverPoint || f && f.isHidden)) {
                    ...
                    if (c.hoverSeries !== p)
                        p.onMouseOver();
                    p && !p.directTouch && (c.hoverPoint && c.hoverPoint.firePointEvent("mouseOut"),
                    m.firePointEvent("mouseOver"));
                    c.hoverPoints = x;
                    c.hoverPoint = m;
                    f && f.refresh(k ? x : m, b)
                } else
                    u && f && !f.isHidden && (p = f.getAnchor([{}], b),
                    f.updatePosition({
                        plotX: p[0],
                        plotY: p[1]
                    }));
            ...
            drag: function(a) {
                var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, p = this.zoomVert, m = b.plotLeft, x = b.plotTop, q = b.plotWidth, y = b.plotHeight, h, l = this.selectionMarker, g = this.mouseDownX, r = this.mouseDownY, n = c.panKey && a[c.panKey + "Key"];
                l && l.touch || (d < m ? d = m : d > m + q && (d = m + q),
                e < x ? e = x : e > x + y && (e = x + y),
                this.hasDragged = Math.sqrt(Math.pow(g - d, 2) + Math.pow(r - e, 2)),
                10 < this.hasDragged && (h = b.isInsidePlot(g - m, r - x),
                b.hasCartesianSeries && (this.zoomX || this.zoomY) && h && !n && !l && (this.selectionMarker = l = b.renderer.rect(m, x, f ? 1 : q, p ? 1 : y, 0).attr({
            ...
            drop: function(a) {
                ...
                if (this.selectionMarker) {
                    var e = {
                        ...
                        xAxis: [],
                        yAxis: []
                    }, m = this.selectionMarker, p = m.attr ? m.attr("x") : m.x, x = m.attr ? m.attr("y") : m.y, h = m.attr ? m.attr("width") : m.width, q = m.attr ? m.attr("height") : m.height, y;
            ...
            onContainerClick: function(a) {
                ...
                b.hoverPoint && c.firePointEvent("click", a)) : (w(a, this.getCoordinates(a)),
                b.isInsidePlot(a.chartX - d, a.chartY - e) && t(b, "click", a)))
            },
            ...
            destroy: function() {
                ...
                a.chartCount || (m(h, "mouseup", b.onDocumentMouseUp),
                m(h, "touchend", b.onDocumentTouchEnd));
    ...
    (function(a) {
        ...
        G(a.Pointer.prototype, {
            pinchTranslate: function(a, f, n, t, e, d) {
                this.zoomHor && this.pinchTranslateDirection(!0, a, f, n, t, e, d);
                this.zoomVert && this.pinchTranslateDirection(!1, a, f, n, t, e, d)
            },
            pinchTranslateDirection: function(a, f, n, t, e, d, m, C) {
                var b = this.chart, x = a ? "x" : "y", c = a ? "X" : "Y", h = "chart" + c, l = a ? "width" : "height", w = b["plot" + (a ? "Left" : "Top")], k, E, p = C || 1, z = b.inverted, M = b.bounds[a ? "h" : "v"], q = 1 === f.length, y = f[0][h], H = n[0][h], K = !q && f[1][h], g = !q && n[1][h], r;
                n = function() {
            ...
            pinch: function(a) {
                ...
                m.x = [t[0].chartX, t[1] && t[1].chartX],
                m.y = [t[0].chartY, t[1] && t[1].chartY],
                A(w.axes, function(a) {
                    if (a.zoomEnabled) {
                ...
                h.res = !0) : h.followTouchMove && 1 === d ? this.runPointActions(h.normalize(a)) : t.length && (b || (h.selectionMarker = b = G({
                    destroy: n,
                    touch: !0
                }, w.plotBox)),
                h.pinchTranslate(t, e, x, b, u, m),
                h.hasPinched = C,
                h.scaleGroups(x, u),
                h.res && (h.res = !1,
                this.reset(!1, 0)))
            ...
            touch: function(h, l) {
                var n = this.chart, t, e;
                if (n.index !== a.hoverChartIndex)
                    this.onContainerMouseLeave({
                        relatedTarget: !0
                    });
                a.hoverChartIndex = n.index;
                1 === h.touches.length ? (h = this.normalize(h),
                (e = n.isInsidePlot(h.chartX - n.plotLeft, h.chartY - n.plotTop)) && !n.openMenu ? (l && this.runPointActions(h),
                "touchmove" === h.type && (l = this.pinchDown,
                t = l[0] ? 4 <= Math.sqrt(Math.pow(l[0].chartX - h.chartX, 2) + Math.pow(l[0].chartY - h.chartY, 2)) : !1),
                f(t, !0) && this.pinch(h)) : l && this.reset()) : 2 === h.touches.length && this.pinch(h)
            },
    ...
    (function(a) {
        ...
        if (!a.hasTouch && (w.PointerEvent || w.MSPointerEvent)) {
            var e = {}
              ...
              , C = function(b, d, c, e) {
                "touch" !== b.pointerType && b.pointerType !== b.MSPOINTER_TYPE_TOUCH || !A[a.hoverChartIndex] || (e(b),
    ...
    (function(a) {
        var D, A = a.addEvent, G = a.css, F = a.discardElement, n = a.defined, f = a.each, h = a.isFirefox, l = a.marginNames, w = a.merge, t = a.pick, e = a.setAnimation, d = a.stableSort, m = a.win, C = a.wrap;
        ...
        D.prototype = {
            ...
            colorizeItem: function(b, d) {
                ...
                m && (p && m.isMarker && (x = b.pointAttribs(),
                d || a.objectEach(x, function(a, b) {
                    x[b] = k
                })),
                m.attr(x))
            },
            ...
            positionCheckboxes: function(a) {
                var b = this.group && this.group.alignAttr, c, d = this.clipHeight || this.legendHeight, e = this.titleHeight;
                b && (c = b.translateY,
                f(this.allItems, function(f) {
                    var k = f.checkbox, m;
                    k && (m = c + e + k.y + (a || 0) + 3,
                    G(k, {
                        left: b.translateX + f.checkboxOffset + k.x - 20 + "px",
                        top: m + "px",
            ...
            renderItem: function(a) {
                ...
                g || (a.legendGroup = c.g("legend-item").addClass("highcharts-" + C.type + "-series highcharts-color-" + a.colorIndex + (A ? " " + A : "") + (r ? " highcharts-series-" + a.index : "")).attr({
                    zIndex: 1
                }).add(this.scrollGroup),
                a.legendItem = g = c.text("", q ? f + k : -k, this.baseline || 0, N).css(w(a.visible ? m : p)).attr({
                    align: q ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup),
                this.baseline || (m = m.fontSize,
                ...
                e && this.itemX - h + f > (y || b.spacingBox.width - 2 * h - d.x) && (this.itemX = h,
                this.itemY += K + this.lastLineHeight + l,
                ...
                e ? this.itemX += f : (this.itemY += K + k + l,
            ...
            render: function() {
                var a = this, e = a.chart, c = e.renderer, m = a.group, h, n, k, l, p = a.box, z = a.options, t = a.padding;
                a.itemX = t;
            ...
            handleOverflow: function(a) {
                var b = this, c = this.chart, d = c.renderer, e = this.options, m = e.y, k = this.padding, c = c.spacingBox.height + ("top" === e.verticalAlign ? -m : m) - k, m = e.maxHeight, h, p = this.clipRect, l = e.navigation, n = t(l.animation, !0), q = l.arrowSize || 12, y = this.nav, H = this.pages, K, g = this.allItems, r = function(a) {
                    "number" === typeof a ? p.attr({
                        height: a
                    }) : p && (b.clipRect = p.destroy(),
                    b.contentGroup.clip());
                ...
                m && (c = Math.min(c, m));
                H.length = 0;
                a > c && !1 !== l.enabled ? (this.clipHeight = h = Math.max(c - 20 - this.titleHeight - k, 0),
                ...
                f(g, function(a, b) {
                    ...
                    var d = H.length;
                    if (!d || c - H[d - 1] > h && (K || c) !== H[d - 1])
                        H.push(K || c),
                        d++;
                    b === g.length - 1 && c + a - H[d - 1] > h && H.push(c);
                    c !== K && (K = c)
                }),
                p || (p = b.clipRect = d.clipRect(0, k, 9999, 0),
                b.contentGroup.clip(p)),
                r(h),
                y || (this.nav = y = d.g().attr({
                    zIndex: 1
                }).add(this.group),
                this.up = d.symbol("triangle", 0, 0, q, q).on("click", function() {
                    b.scroll(-1, n)
                }).add(y),
                this.pager = d.text("", 15, 10).addClass("highcharts-legend-navigation").css(l.style).add(y),
                this.down = d.symbol("triangle-down", 0, 0, q, q).on("click", function() {
                    b.scroll(1, n)
                }).add(y)),
                b.scroll(0),
                a = c) : y && (r(),
        ...
        a.LegendSymbolMixin = {
            ...
            drawLineMarker: function(a) {
                ...
                c && !1 !== c.enabled && (b = Math.min(t(c.radius, f), f),
                0 === this.symbol.indexOf("url") && (c = w(c, {
                    width: e,
                    height: e
                }),
                b = 0),
                this.legendSymbol = c = k.symbol(this.symbol, d / 2 - b, a - b, 2 * b, 2 * b, c).addClass("highcharts-point").add(m),
                c.isMarker = !0)
            }
        };
        (/Trident\/7\.0/.test(m.navigator.userAgent) || h) && C(D.prototype, "positionItem", function(a, d) {
            var b = this
              , e = function() {
    ...
    (function(a) {
        ...
        C(P.prototype, {
            ...
            init: function(b, c) {
                var d, g, e = b.series, q = b.plotOptions || {};
                b.series = null;
                d = z(l, b);
                for (g in d.plotOptions)
                    d.plotOptions[g].tooltip = q[g] && z(q[g].tooltip) || void 0;
            ...
            redraw: function(b) {
                var c = this.axes, d = this.series, g = this.pointer, e = this.legend, q = this.isDirtyLegend, f, k, p = this.hasCartesianSeries, y = this.isDirtyBox, r, h = this.renderer, v = h.isHidden(), l = [];
            ...
            getSelectedSeries: function() {
                return u(this.series, function(a) {
                    return a.selected
                })
            },
            ...
            layOutTitles: function(a) {
                ...
                m(["title", "subtitle"], function(a) {
                    ...
                    var q;
                    c && (q = e.style.fontSize,
                    q = d.fontMetrics(q, c).b,
                    c.css({
            ...
            temporaryDisplay: function(b) {
                ...
                if (b)
                    for (; d && d.style; )
                        d.hcOrigStyle && (a.css(d, d.hcOrigStyle),
                        delete d.hcOrigStyle),
                        d = d.parentNode;
                else
                    for (; d && d.style; )
                        "none" === c(d, "display", !1) && (d.hcOrigStyle = {
                        ...
                        d.style.setProperty && d.style.setProperty("display", "block", "important")),
                        d = d.parentNode
            },
            ...
            reflow: function(a) {
                ...
                if (!q && !b.isPrinting && f && g && (e === N || e === n)) {
                    if (f !== b.containerWidth || g !== b.containerHeight)
                        clearTimeout(b.reflowTimeout),
                        b.reflowTimeout = J(function() {
            ...
            setChartSize: function(a) {
                var b = this.inverted, c = this.renderer, d = this.chartWidth, g = this.chartHeight, e = this.options.chart, q = this.spacing, f = this.clipOffset, k, p, y, r;
            ...
            drawChartBox: function() {
                ...
                t = "animate";
                e || (t = "attr",
                this.plotBackground = e = b.rect().addClass("highcharts-plot-background").add());
                e[t](x);
                e.attr({
                    fill: p || "none"
                }).shadow(a.plotShadow);
                y && (k ? k.animate(x) : this.plotBGImage = b.image(y, h, l, n, H).add());
                u ? u.animate({
                    width: z.width,
                    height: z.height
                ...
                t = "animate";
                q || (t = "attr",
                this.plotBorder = q = b.rect().addClass("highcharts-plot-border").attr({
                    zIndex: 1
                }).add());
                q.attr({
            ...
            propFromSeries: function() {
                var a = this, b = a.options.chart, c, d = a.options.series, e, q;
                m(["inverted", "angular", "polar"], function(f) {
                    c = g[b.type || b.defaultSeriesType];
                    q = b[f] || c && c.prototype[f];
                    for (e = d && d.length; !q && e--; )
                        (c = g[d[e].type]) && c.prototype[f] && (q = !0);
                    a[f] = q
                })
            },
            linkSeries: function() {
                ...
                m(b, function(b) {
                    ...
                    k(c) && (c = ":previous" === c ? a.series[b.index - 1] : a.get(c)) && c.linkedParent !== b && (c.linkedSeries.push(b),
                    b.linkedParent = c,
            ...
            destroy: function() {
                var b = this, c = b.axes, d = b.series, g = b.container, e, q = g && g.parentNode;
                x(b, "destroy");
    ...
    (function(a) {
        var D, A = a.each, G = a.extend, F = a.erase, n = a.fireEvent, f = a.format, h = a.isArray, l = a.isNumber, w = a.pick, t = a.removeEvent;
        D = a.Point = function() {}
        ;
        D.prototype = {
            init: function(a, d, f) {
                ...
                f = a.colorCounter,
                a.colorCounter++,
                a.colorCounter === d && (a.colorCounter = 0)) : f = a.colorIndex;
            ...
            optionsToObject: function(a) {
                ...
                if (l(a) || null === a)
                    ...
                    for (!f && a.length > n && (e = typeof a[0],
                    "string" === e ? d.name = a[0] : "number" === e && (d.x = a[0]),
                    c++); u < n; )
                        f && void 0 === a[c] || (d[b[u]] = a[c]),
                        c++,
                        u++;
                else
                    "object" === typeof a && (d = a,
            ...
            getZone: function() {
                var a = this.series, d = a.zones, a = a.zoneAxis || "y", f = 0, h;
    ...
    (function(a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            autoIncrement: function() {
                ...
                d && (a = new f(b),
                "day" === d ? a = +a[f.hcSetDate](a[f.hcGetDate]() + c) : "month" === d ? a = +a[f.hcSetMonth](a[f.hcGetMonth]() + c) : "year" === d && (a = +a[f.hcSetFullYear](a[f.hcGetFullYear]() + c)),
                c = a - b);
                this.xIncrement = b + c;
                return b
            },
            ...
            getCyclic: function(a, b, c) {
                var d, g = this.chart, e = this.userOptions, q = a + "Index", f = a + "Counter", k = c ? c.length : I(g.options.chart[a + "Count"], g[a + "Count"]);
                b || (d = I(e[q], e["_" + q]),
                w(d) || (g.series.length || (g[f] = 0),
                e["_" + q] = d = g[f] % k,
                g[f] += 1),
                c && (b = c[d]));
                void 0 !== d && (this[q] = d);
            ...
            setData: function(d, e, f, k) {
                var g = this, q = g.points, m = q && q.length || 0, p, h = g.options, y = g.chart, l = null, n = g.xAxis, u = h.turboThreshold, z = this.xData, H = this.yData, w = (p = g.pointArrayMap) && p.length;
                d = d || [];
                p = d.length;
                e = I(e, !0);
                if (!1 !== k && p && m === p && !g.cropped && !g.hasGroupedData && g.visible)
                    t(d, function(a, b) {
                    ...
                    if (u && p > u) {
                        ...
                        for (f = 0; f < p; f++)
                            ...
                            g.pointClass.prototype.applyOptions.apply(l, [d[f]]),
                            g.updateParallelArrays(l, f));
                    c(H[0]) && a.error(14, !0);
                    g.data = [];
                    g.options.data = g.userOptions.data = d;
                    for (f = m; f--; )
                        q[f] && q[f].destroy && q[f].destroy();
                    n && (n.minRange = n.userMinRange);
                    g.isDirty = y.isDirtyBox = !0;
                    g.isDirtyData = !!q;
                    f = !1
                }
                "point" === h.legendType && (this.processData(),
                this.generatePoints());
                e && y.redraw(f)
            },
            processData: function(b) {
                ...
                g = 0;
                var f, q, k = this.xAxis, m, p = this.options;
                m = p.cropThreshold;
                var h = this.getExtremesFromAll || p.getExtremesFromAll, l = this.isCartesian, p = k && k.val2lin, n = k && k.isLog, u, x;
                if (l && !this.isDirty && !k.isDirty && !this.yAxis.isDirty && !b)
                    return !1;
                k && (b = k.getExtremes(),
                u = b.min,
                x = b.max);
                if (l && this.sorted && !h && (!m || e > m || this.forceCrop))
                    if (c[e - 1] < u || c[0] > x)
                        c = [],
                        d = [];
                    else if (c[0] < u || c[e - 1] > x)
                        g = this.cropData(this.xData, this.yData, u, x),
                        c = g.xData,
                        d = g.yData,
                        g = g.start,
                        f = !0;
                for (m = c.length || 1; --m; )
                    e = n ? p(c[m]) - p(c[m - 1]) : c[m] - c[m - 1],
                    0 < e && (void 0 === q || e < q) ? q = e : 0 > e && this.requireSorting && a.error(15);
                this.cropped = f;
                this.cropStart = g;
            ...
            cropData: function(a, b, c, d) {
                var g = a.length, e = 0, f = g, q = I(this.cropShoulder, 1), k;
                for (k = 0; k < g; k++)
                    if (a[k] >= c) {
                        e = Math.max(0, k - q);
                        break
            ...
            generatePoints: function() {
                var a = this.options, b = a.data, c = this.data, d, g = this.processedXData, e = this.processedYData, f = this.pointClass, k = g.length, m = this.cropStart || 0, p, h = this.hasGroupedData, a = a.keys, l, n = [], u;
                c || h || (c = [],
                c.length = b.length,
                c = this.data = c);
                ...
                for (u = 0; u < k; u++)
                    p = m + u,
                    h ? (l = (new f).init(this, [g[u]].concat(E(e[u]))),
                    l.dataGroup = this.groupMap[u]) : (l = c[p]) || void 0 === b[p] || (c[p] = l = (new f).init(this, b[p], g[u])),
                    l && (l.index = p,
                    n[u] = l);
                this.options.keys = a;
                if (c && (k !== (d = c.length) || h))
                    for (u = 0; u < d; u++)
                        u !== m || h || (u += k),
                        c[u] && (c[u].destroyElements(),
                        c[u].plotX = void 0);
                this.data = c;
                this.points = n
            },
            getExtremes: function(a) {
                var c = this.yAxis, d = this.processedXData, e, g = [], f = 0;
                e = this.xAxis.getExtremes();
                var q = e.min, k = e.max, m, p, h, l;
                a = a || this.stackedYData || this.processedYData || [];
                e = a.length;
                for (l = 0; l < e; l++)
                    if (p = d[l],
                    h = a[l],
                    m = (x(h, !0) || b(h)) && (!c.positiveValuesOnly || h.length || 0 < h),
                    p = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (d[l] || p) >= q && (d[l] || p) <= k,
                    m && p)
                        if (m = h.length)
                            for (; m--; )
                                null !== h[m] && (g[f++] = h[m]);
            ...
            translate: function() {
                ...
                this.generatePoints();
                var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, g = this.yAxis, e = this.points, f = e.length, k = !!this.modifyValue, m = a.pointPlacement, p = "between" === m || x(m), h = a.threshold, l = a.startFromThreshold ? h : 0, u, z, t, E, C = Number.MAX_VALUE;
                "between" === m && (m = .5);
                ...
                for (a = 0; a < f; a++) {
                    var B = e[a]
                      ...
                      , A = B.y;
                    z = B.low;
                    var D = b && g.stacks[(this.negStacks && A < (l ? 0 : h) ? "-" : "") + this.stackKey], F;
                    g.positiveValuesOnly && null !== A && 0 >= A && (B.isNull = !0);
                    B.plotX = u = n(Math.min(Math.max(-1E5, c.translate(M, 0, 0, 0, 1, m, "flags" === this.type)), 1E5));
                    b && this.visible && !B.isNull && D && D[M] && (E = this.getStackIndicator(E, M, this.index),
                    F = D[M],
                    A = F.points[E.key],
                    z = A[0],
                    A = A[1],
                    z === l && E.key === D[M].base && (z = I(h, g.min)),
                    g.positiveValuesOnly && 0 >= z && (z = null),
                    B.total = B.stackTotal = F.total,
                    B.percentage = F.total && B.y / F.total * 100,
                    B.stackY = A,
                    ...
                    B.isNull || (void 0 !== t && (C = Math.min(C, Math.abs(u - t))),
                    t = u);
            ...
            setClip: function(a) {
                var b = this.chart
                  ...
                  , m = b[q + "m"];
                k || (a && (f.width = 0,
                b[q + "m"] = m = d.clipRect(-99, g ? -b.plotLeft : -b.plotTop, 99, g ? b.chartWidth : b.chartHeight)),
                b[q] = k = d.clipRect(f),
                k.count = {
                    length: 0
                });
                ...
                k.count.length += 1);
                !1 !== c.clip && (this.group.clip(a || e ? k : b.clipRect),
                this.markerGroup.clip(m),
                this.sharedClipKey = q);
                a || (k.count[this.index] && (delete k.count[this.index],
                --k.count.length),
                0 === k.count.length && q && b[q] && (e || (b[q] = b[q].destroy()),
                b[q + "m"] && (b[q + "m"] = b[q + "m"].destroy())))
            },
            animate: function(a) {
            ...
            drawPoints: function() {
                var a = this.points, b = this.chart, c, d, g, e, f = this.options.marker, k, m, p, h, l = this[this.specialGroup] || this.markerGroup, n = I(f.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx >= 2 * f.radius);
                if (!1 !== f.enabled || this._hasPointMarkers)
                    for (d = 0; d < a.length; d++)
                        ...
                        k = g.marker || {},
                        m = !!g.marker,
                        p = n && void 0 === k.enabled || k.enabled,
                        h = g.isInside,
                        p && x(c) && null !== g.y ? (c = I(k.symbol, this.symbol),
                        g.hasImage = 0 === c.indexOf("url"),
                        p = this.markerAttribs(g, g.selected && "select"),
                        e ? e[h ? "show" : "hide"](!0).animate(p) : h && (0 < p.width || g.hasImage) && (g.graphic = e = b.renderer.symbol(c, p.x, p.y, p.width, p.height, m ? k : f).add(l)),
                        e && e.attr(this.pointAttribs(g, g.selected && "select")),
                        e && e.addClass(g.getClassName(), !0)) : e && (g.graphic = e.destroy())
            },
            markerAttribs: function(a, b) {
                ...
                g = I(b && b.radius, c && c.radius, g + (c && c.radiusPlus || 0)));
                a.hasImage && (g = 0);
                a = {
            ...
            pointAttribs: function(a, b) {
                ...
                d = I(b.lineWidth, c.lineWidth, d + I(b.lineWidthPlus, c.lineWidthPlus, 0)),
            ...
            destroy: function() {
                var a = this, b = a.chart, c = /AppleWebKit\/533/.test(M.navigator.userAgent), d, g, f = a.data || [], h, l;
                m(a, "destroy");
                k(a);
                ...
                B(a, function(a, b) {
                    a instanceof p && !a.survive && (d = c && "group" === b ? "hide" : "destroy",
                    a[d]())
                });
            ...
            getGraphPath: function(a, b, c) {
                var d = this, g = d.options, e = g.step, f, k = [], q = [], m;
                a = a || d.points;
                ...
                t(a, function(f, p) {
                    ...
                    f.isNull && !w(b) && 0 < p ? m = !g.connectNulls : f.isNull && !b ? m = !0 : (0 === p || m ? p = ["M", f.plotX, f.plotY] : d.getPointSpline ? p = d.getPointSpline(a, f, p) : e ? (p = 1 === e ? ["L", n.plotX, l] : 2 === e ? ["L", (n.plotX + h) / 2, n.plotY, "L", (n.plotX + h) / 2, l] : ["L", h, n.plotY],
                    p.push("L", h, l)) : p = ["L", h, l],
                    q.push(f.x),
                    e && q.push(f.x),
                    k.push.apply(k, p),
                    m = !1)
            ...
            applyZones: function() {
                var a = this, b = this.chart, c = b.renderer, d = this.zones, g, e, f = this.clips || [], k, m = this.graph, p = this.area, h = Math.max(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], n, u, x = b.inverted, z, E, w, B, C = !1;
                d.length && (m || p) && l && void 0 !== l.min && (u = l.reversed,
                z = l.horiz,
                m && m.hide(),
                p && p.hide(),
                n = l.getExtremes(),
                t(d, function(d, q) {
                    ...
                    f[q] ? f[q].animate(k) : (f[q] = c.clipRect(k),
                    m && a["zone-graph-" + q].clip(f[q]),
                    p && a["zone-area-" + q].clip(f[q]));
                    C = d.value > n.max
                }),
                this.clips = f)
            },
            ...
            render: function() {
                var a = this, b = a.chart, c, d = a.options, g = !!a.animate && b.renderer.isSVG && A(d.animation).duration, e = a.visible ? "inherit" : "hidden", f = d.zIndex, k = a.hasRendered, m = b.seriesGroup, p = b.inverted;
            ...
            searchKDTree: function(a, b) {
                function c(a, b, g, m) {
                    var p = b.point, q = d.kdAxisArray[g % m], h, l, n = p;
                    l = w(a[e]) && w(p[e]) ? Math.pow(a[e] - p[e], 2) : null;
                    ...
                    b[h] && (h = c(a, b[h], g + 1, m),
                    n = h[k] < n[k] ? h : p);
                    b[l] && Math.sqrt(q * q) < n[k] && (a = c(a, b[l], g + 1, m),
                    n = a[k] < n[k] ? a : n);
                    return n
                }
                var d = this
    ...
    (function(a) {
        ...
        D.prototype = {
            ...
            setOffset: function(a, d) {
                ...
                if (d = this.label)
                    d.align(this.alignOptions, null, b),
                    b = d.alignAttr,
                    d[!1 === this.options.crop || f.isInsidePlot(b.x, b.y) ? "show" : "hide"](!0)
            }
        };
        ...
        A.prototype.buildStacks = function() {
            var a = this.series, d, f = t(this.options.reversedStacks, !0), h = a.length, b;
            if (!this.isXAxis) {
                this.usePercentage = !1;
                for (b = h; b--; )
                    a[f ? b : h - b - 1].setStackedPoints();
                for (b = h; b--; )
                    d = a[f ? b : h - b - 1],
        ...
        a.prototype.setStackedPoints = function() {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var a = this.processedXData, d = this.processedYData, f = [], h = d.length, b = this.options, l = b.threshold, c = b.startFromThreshold ? l : 0, u = b.stack, b = b.stacking, w = this.stackKey, A = "-" + w, k = this.negStacks, E = this.yAxis, p = E.stacks, z = E.oldStacks, M, q, y, H, K, g, r;
                E.stacksTouched += 1;
                for (K = 0; K < h; K++)
                    g = a[K],
                    r = d[K],
                    ...
                    y = (q = k && r < (c ? 0 : l)) ? A : w,
                    p[y] || (p[y] = {}),
                    p[y][g] || (z[y] && z[y][g] ? (p[y][g] = z[y][g],
                    p[y][g].total = null) : p[y][g] = new D(E,E.options.stackLabels,q,g,u)),
                    y = p[y][g],
                    null !== r && (y.points[H] = y.points[this.index] = [t(y.cum, c)],
                    n(y.cum) || (y.base = H),
                    y.touched = E.stacksTouched,
                    0 < M.index && !1 === this.singleStacks && (y.points[H][0] = y.points[this.index + "," + g + ",0"][0])),
                    "percent" === b ? (q = q ? w : A,
                    k && p[q] && p[q][g] ? (q = p[q][g],
                    y.total = q.total = Math.max(q.total, y.total) + Math.abs(r) || 0) : y.total = F(y.total + (Math.abs(r) || 0))) : y.total = F(y.total + (r || 0)),
                    y.cum = t(y.cum, c) + (r || 0),
                    null !== r && (y.points[H].push(y.cum),
                    f[K] = y.cum);
        ...
        a.prototype.setPercentStacks = function() {
            var a = this, d = a.stackKey, f = a.yAxis.stacks, l = a.processedXData, b;
            h([d, "-" + d], function(d) {
                for (var c = l.length, e, h; c--; )
                    if (e = l[c],
                    b = a.getStackIndicator(b, e, a.index, d),
                    e = (h = f[d] && f[d][e]) && h.points[b.key])
    ...
    (function(a) {
        ...
        w(a.Chart.prototype, {
            ...
            update: function(a, k) {
                ...
                if (l) {
                    ...
                    "alignTicks"in l && (n = !0);
                    x(l, function(a, b) {
                        -1 !== e("chart." + b, p.propsRequireUpdateSeries) && (u = !0);
                        -1 !== e(b, p.propsRequireDirtyBox) && (p.isDirtyBox = !0)
                    });
        ...
        w(u.prototype, {
            update: function(a, b, d, e) {
                function f() {
                    ...
                    m(a, !0) && (g && g.element && a && a.marker && a.marker.symbol && (k.graphic = g.destroy()),
                ...
                var k = this, p = k.series, g = k.graphic, h, q = p.chart, l = p.options;
                b = c(b, !0);
        ...
        w(B.prototype, {
            addPoint: function(a, b, d, e) {
                var f = this.options, k = this.data, p = this.chart, g = this.xAxis, g = g && g.hasNames && g.names, h = f.data, m, q, l = this.xData, n, u;
                b = c(b, !0);
                m = {
                    series: this
                };
            ...
            update: function(a, d) {
                var e = this, f = e.chart, k = e.userOptions, p = e.oldType || e.type, m = a.type || k.type || f.options.chart.type, g = I[p].prototype, l = ["group", "markerGroup", "dataLabelsGroup"], n;
                if (m && m !== p || void 0 !== a.zIndex)
                    l.length = 0;
                h(l, function(a) {
                    l[a] = e[a];
                    delete e[a]
        ...
        w(G.prototype, {
            update: function(a, d) {
                var e = this.chart;
                a = e.options[this.coll][this.options.index] = b(this.userOptions, a);
                this.destroy(!0);
                this.init(e, w(a, {
                    events: void 0
                }));
            ...
            remove: function(a) {
                for (var b = this.chart, d = this.coll, e = this.series, f = e.length; f--; )
                    e[f] && e[f].remove(!1);
                l(b.axes, this);
                l(b[d], this);
    ...
    (function(a) {
        ...
        f("area", "line", {
            ...
            getStackPoints: function() {
                var f = [], l = [], n = this.xAxis, t = this.yAxis, e = t.stacks[this.stackKey], d = {}, m = this.points, C = this.index, b = t.series, x = b.length, c, u = F(t.options.reversedStacks, !0) ? 1 : -1, B;
                        ...
                        if (d[a] && !d[a].isNull)
                            ...
                            A([-1, 1], function(f) {
                                ...
                                if (n)
                                    for (B = C; 0 <= B && B < x; )
                                        h = n.points[B],
                                        h || (B === C ? d[a][k] = !0 : c[B] && (m = e[a].points[B]) && (p -= m[1] - m[0])),
                                        B += u;
            ...
            getGraphPath: function(a) {
                var f = n.prototype.getGraphPath, h = this.options, t = h.stacking, e = this.yAxis, d, m, C = [], b = [], x = this.index, c, u = e.stacks[this.stackKey], B = h.threshold, A = e.getThreshold(h.threshold), k, h = h.connectNulls || "percent" === t, E = function(d, f, k) {
                    var h = a[d];
                    d = t && u[h.x].points[x];
                    var p = h[k + "Null"] || 0;
                    k = h[k + "Cliff"] || 0;
            ...
            drawGraph: function() {
                ...
                var a = this
                  , f = this.areaPath
                  , w = this.options
                  , t = [["area", "highcharts-area", this.color, w.fillColor]];
        ...
        a("spline", "line", {}, {
            getPointSpline: function(a, G, F) {
                ...
                if (h && !h.isNull && !1 !== h.doCurve && !G.isCliff && F && !F.isNull && !1 !== F.doCurve && !G.isCliff) {
                    ...
                    w += d;
                    e += d;
                    w > a && w > f ? (w = Math.max(a, f),
                    e = 2 * f - w) : w < a && w < f && (w = Math.min(a, f),
                    e = 2 * f - w);
                    e > F && e > f ? (e = Math.max(F, f),
                    w = 2 * f - e) : e < F && e < f && (e = Math.min(F, f),
                    w = 2 * f - e);
                    G.rightContX = t;
                    G.rightContY = e
                }
    ...
    (function(a) {
        ...
        w("column", "line", {
            ...
            getColumnMetrics: function() {
                var a = this, d = a.options, f = a.xAxis, l = a.yAxis, b = f.reversed, n, c = {}, u = 0;
                !1 === d.grouping ? u = 1 : G(a.chart.series, function(b) {
                    var d = b.options, e = b.yAxis, f;
                    b.type === a.type && b.visible && l.len === e.len && l.pos === e.pos && (d.stacking ? (n = b.stackKey,
                    void 0 === c[n] && (c[n] = u++),
                    f = c[n]) : !1 !== d.grouping && (f = u++),
                    b.columnIndex = f)
                });
            ...
            crispCol: function(a, d, f, h) {
                ...
                this.options.crisp && (f = Math.round(a + f) + c,
                a = Math.round(a) + c,
                f -= a);
                h = Math.round(d + h) + e;
                c = .5 >= Math.abs(d) && .5 < h;
            ...
            translate: function() {
                ...
                G(a.points, function(e) {
                    var f = h(e.yBottom, x), m = 999 + Math.abs(f), m = Math.min(Math.max(-m, e.plotY), b.len + m), l = e.plotX + k, q = w, n = Math.min(m, f), u, E = Math.max(m, f) - n;
                    Math.abs(E) < c && c && (E = c,
                    u = !b.reversed && !e.negative || b.reversed && e.negative,
                    n = Math.abs(n - x) > c ? f - c : x - (u ? c : 0));
                    e.barX = l;
                    e.pointWidth = t;
                    e.tooltipPos = d.inverted ? [b.len + b.pos - d.plotLeft - m, a.xAxis.len - l - q / 2, E] : [l + q / 2, m + b.pos - d.plotTop, E];
                    e.shapeType = "rect";
                    e.shapeArgs = a.crispCol.apply(a, e.isNull ? [l, x, q, 0] : [l, n, q, E])
                })
            },
            getSymbol: a.noop,
            drawLegendSymbol: a.LegendSymbolMixin.drawRectangle,
            ...
            pointAttribs: function(a, d) {
                var e = this.options, h, b = this.pointAttrToOptions || {};
                ...
                var l = b["stroke-width"] || "borderWidth"
                  ...
                  , t = a[l] || e[l] || this[l] || 0
                  , b = e.dashStyle;
                a && this.zones.length && (c = a.getZone(),
                c = a.options.color || c && c.color || this.color);
                d && (a = f(e.states[d], a.options.states && a.options.states[d] || {}),
                d = a.brightness,
                c = a.color || void 0 !== d && A(c).brighten(a.brightness).get() || c,
                n = a[h] || n,
                t = a[l] || t,
                b = a.dashStyle || b);
                h = {
            ...
            drawPoints: function() {
                var a = this, d = this.chart, h = a.options, l = d.renderer, b = h.animationLimit || 250, t;
                G(a.points, function(c) {
                    var e = c.graphic;
                    if (n(c.plotY) && null !== c.y) {
                        t = c.shapeArgs;
                        if (e)
                            e[d.pointCount < b ? "animate" : "attr"](f(t));
                        else
                            c.graphic = e = l[c.shapeType](t).add(c.group || a.group);
            ...
            animate: function(a) {
                ...
                b ? h.translateX = a - e.len : h.translateY = a,
                d.group.attr(h)) : (h[b ? "translateX" : "translateY"] = e.pos,
                d.group.animate(h, F(D(d.options.animation), {
                    step: function(a, b) {
                        d.group.attr({
    ...
    (function(a) {
        ...
        a.CenteredSeriesMixin = {
            getCenter: function() {
                var a = this.options, F = this.chart, n = 2 * (a.slicedOffset || 0), f = F.plotWidth - 2 * n, F = F.plotHeight - 2 * n, h = a.center, h = [D(h[0], "50%"), D(h[1], "50%"), a.size || "100%", a.innerSize || 0], l = Math.min(f, F), w, t;
                for (w = 0; 4 > w; ++w)
                    t = h[w],
                    a = 2 > w || 2 === w && /%$/.test(t),
                    h[w] = A(t, [f, F, l, h[2]][w]) + (a ? n : 0);
                h[3] > h[2] && (h[3] = h[2]);
                return h
            }
        }
    ...
    (function(a) {
        ...
        t("pie", "line", {
            ...
            updateTotals: function() {
                var a, e = 0, f = this.points, b = f.length, h, c = this.options.ignoreHiddenPoint;
                for (a = 0; a < b; a++)
                    h = f[a],
                    e += c && !h.visible ? 0 : h.isNull ? 0 : h.y;
                this.total = e;
                for (a = 0; a < b; a++)
                    h = f[a],
            ...
            translate: function(a) {
                this.generatePoints();
                var d = 0, e = this.options, b = e.slicedOffset, f = b + (e.borderWidth || 0), c, l, n, t = e.startAngle || 0, k = this.startAngleRad = Math.PI / 180 * (t - 90), t = (this.endAngleRad = Math.PI / 180 * (h(e.endAngle, t + 360) - 90)) - k, w = this.points, p, z = e.dataLabels.distance, e = e.ignoreHiddenPoint, A, q = w.length, y;
                ...
                for (A = 0; A < q; A++) {
                    y = w[A];
                    y.labelDistance = h(y.options.dataLabels && y.options.dataLabels.distance, z);
            ...
            drawGraph: null,
            drawPoints: function() {
                var a = this, e = a.chart.renderer, f, b, h, c, l = a.options.shadow;
                ...
                G(a.points, function(d) {
                    if (!d.isNull) {
                        ...
                        b ? b.setRadialReference(a.center).attr(h).animate(F(c, f)) : (d.graphic = b = e[d.shapeType](c).setRadialReference(a.center).attr(f).add(a.group),
                        d.visible || b.attr({
                            visibility: "hidden"
                        }),
                        b.attr(h).attr({
            ...
            setVisible: function(a, e) {
                ...
                b.options.data[n(d, b.data)] = d.options,
                G(["graphic", "dataLabel", "connector", "shadowGroup"], function(b) {
                    if (d[b])
                        d[b][a ? "show" : "hide"](!0)
                }),
    ...
    (function(a) {
        ...
        a.distribute = function(a, d) {
            ...
            for (a = h(a, function(a) {
                ...
                for (e = a.length; e--; )
                    ...
                    f.pos = Math.min(Math.max(0, n - f.size / 2), d - f.size);
                e = a.length;
                for (f = !1; e--; )
                    0 < e && a[e - 1].pos + a[e - 1].size > a[e].pos && (a[e - 1].size += a[e].size,
                    a[e - 1].targets = a[e - 1].targets.concat(a[e].targets),
                    a[e - 1].pos + a[e - 1].size > d && (a[e - 1].pos = d - a[e - 1].size),
                    a.splice(e, 1),
                    f = !0)
            }
            e = 0;
        ...
        d.prototype.drawDataLabels = function() {
            var b = this, d = b.options, c = d.dataLabels, e = b.points, h, n, k = b.hasRendered || 0, m, p, z = t(c.defer, !0), w = b.chart.renderer;
            if (c.enabled || b._hasPointLabels)
                b.dlProcessOptions && b.dlProcessOptions(c),
                p = b.plotGroup("dataLabelsGroup", "data-labels", z && !k ? "hidden" : "visible", c.zIndex || 6),
                z && (p.attr({
                    opacity: +k
                }),
                ...
                n = c,
                F(e, function(e) {
                    var k, q = e.dataLabel, u, g, r = e.connector, x = !q, z;
                    h = e.dlOptions || e.options && e.options.dataLabels;
                    if (k = t(h && h.enabled, n.enabled) && null !== e.y)
                        c = l(n, h),
                        u = e.getLabelConfig(),
                        m = c.format ? f(c.format, u) : c.formatter.call(u, c),
                        z = c.style,
                        u = c.rotation,
                        z.color = t(c.color, z.color, b.color, "#000000"),
                        "contrast" === z.color && (e.contrastColor = w.getContrast(e.color || b.color),
                        z.color = c.inside || 0 > t(e.labelDistance, c.distance) || d.stacking ? e.contrastColor : "#000000"),
                    ...
                    !q || k && G(m) ? k && G(m) && (q ? g.text = m : (q = e.dataLabel = w[u ? "text" : "label"](m, 0, -9999, c.shape, null, null, c.useHTML, null, "data-label"),
                    q.addClass("highcharts-data-label-color-" + e.colorIndex + " " + (c.className || "") + (c.useHTML ? "highcharts-tracker" : ""))),
                    q.attr(g),
                    q.css(z).shadow(c.shadow),
                    q.added || q.add(p),
                    b.alignDataLabel(e, q, c, null, x)) : (e.dataLabel = q = q.destroy(),
                    r && (e.connector = r.destroy()))
                })
        }
        ;
        d.prototype.alignDataLabel = function(a, d, c, e, f) {
            var b = this.chart, k = b.inverted, h = t(a.plotX, -9999), p = t(a.plotY, -9999), l = d.getBBox(), m, q = c.rotation, u = c.align, x = this.visible && (a.series.forceDL || b.isInsidePlot(h, Math.round(p), k) || e && b.isInsidePlot(h, k ? e.x + 1 : e.y + e.height - 1, k)), w = "justify" === t(c.overflow, "justify");
            if (x && (m = c.style.fontSize,
            m = b.renderer.fontMetrics(m, d).b,
            e = n({
                x: k ? b.plotWidth - p : h,
            ...
            p = (q + 720) % 360,
            p = 180 < p && 360 > p,
            "left" === u ? h.y -= p ? l.height : 0 : "center" === u ? (h.x -= l.width / 2,
            h.y -= l.height / 2) : "right" === u && (h.x -= l.width,
            h.y -= p ? 0 : l.height)) : (d.align(c, null, e),
            h = d.alignAttr),
            w ? a.isLabelJustified = this.justifyDataLabel(d, c, h, l, e, f) : t(c.crop, !0) && (x = b.isInsidePlot(h.x, h.y) && b.isInsidePlot(h.x + l.width, h.y + l.height)),
            c.shape && !q))
                d[f ? "attr" : "animate"]({
        ...
        d.prototype.justifyDataLabel = function(a, d, c, e, f, h) {
            var b = this.chart, l = d.align, p = d.verticalAlign, n, m, q = a.box ? 0 : a.padding || 0;
            n = c.x + q;
            0 > n && ("right" === l ? d.align = "left" : d.x = -n,
            m = !0);
            n = c.x + e.width - q;
            n > b.plotWidth && ("left" === l ? d.align = "right" : d.x = b.plotWidth - n,
            m = !0);
            n = c.y + q;
            0 > n && ("bottom" === p ? d.verticalAlign = "top" : d.y = -n,
            m = !0);
            n = c.y + e.height - q;
            n > b.plotHeight && ("top" === p ? d.verticalAlign = "bottom" : d.y = b.plotHeight - n,
            m = !0);
            m && (a.placed = !h,
            a.align(d, null, f));
            return m
        ...
        m.pie && (m.pie.prototype.drawDataLabels = function() {
            var b = this, e = b.data, c, f = b.chart, h = b.options.dataLabels, l = t(h.connectorPadding, 10), k = t(h.connectorWidth, 1), n = f.plotWidth, p = f.plotHeight, m, w = b.center, q = w[2] / 2, y = w[1], C, D, g, r, L = [[], []], J, N, O, P, v = [0, 0, 0, 0];
            ...
            F(L, function(d, e) {
                var k, m, t = d.length, u = [], x;
                if (t)
                    for (b.sortByAngle(d, e - .5),
                    0 < b.maxLabelDistance && (k = Math.max(0, y - q - b.maxLabelDistance),
                    m = Math.min(y + q + b.maxLabelDistance, f.plotHeight),
                    F(d, function(a) {
                        0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, y - q - a.labelDistance),
                        a.bottom = Math.min(y + q + a.labelDistance, f.plotHeight),
                        x = a.dataLabel.getBBox().height || 21,
                        a.positionsIndex = u.push({
                            target: a.labelPos[1] - a.top + x / 2,
                            size: x,
                            rank: a.y
                        }) - 1)
                    }),
                    a.distribute(u, m + x - k)),
                    P = 0; P < t; P++)
                        c = d[P],
                        m = c.positionsIndex,
                        g = c.labelPos,
                        ...
                        k = g[1],
                        u && G(u[m]) ? void 0 === u[m].pos ? O = "hidden" : (r = u[m].size,
                        N = c.top + u[m].pos) : N = k,
                        delete c.positionIndex,
                        J = h.justify ? w[0] + (e ? -1 : 1) * (q + c.labelDistance) : b.getX(N < c.top + 2 || N > c.bottom - 2 ? k : N, e, c),
                        C._attr = {
                            visibility: O,
                            align: g[6]
                        },
                        ...
                        g.x = J,
                        g.y = N,
                        null === b.options.size && (D = C.getBBox().width,
                        k = null,
                        J - D < l ? (k = Math.round(D - J + l),
                        v[3] = Math.max(k, v[3])) : J + D > n - l && (k = Math.round(J + D - n + l),
                        v[1] = Math.max(k, v[1])),
                        0 > N - r / 2 ? v[0] = Math.max(Math.round(-N + r / 2), v[0]) : N + r / 2 > p && (v[2] = Math.max(Math.round(N + r / 2 - p), v[2])),
                        C.sideOverflow = k)
            }),
            0 === A(v) || this.verifyDataLabelOverflow(v)) && (this.placeDataLabels(),
            k && F(this.points, function(a) {
                var c;
                m = a.connector;
                if ((C = a.dataLabel) && C._pos && a.visible && 0 < a.labelDistance) {
                    O = C._attr.visibility;
                    if (c = !m)
                        a.connector = m = f.renderer.path().addClass("highcharts-data-label-connector highcharts-color-" + a.colorIndex).add(b.dataLabelsGroup),
                        m.attr({
                            "stroke-width": k,
        ...
        m.pie.prototype.verifyDataLabelOverflow = function(a) {
            var b = this.center, c = this.options, d = c.center, f = c.minSize || 80, h, k;
            null !== d[0] ? h = Math.max(b[2] - Math.max(a[1], a[3]), f) : (h = Math.max(b[2] - a[1] - a[3], f),
            b[0] += (a[3] - a[1]) / 2);
            null !== d[1] ? h = Math.max(Math.min(h, b[2] - Math.max(a[0], a[2])), f) : (h = Math.max(Math.min(h, b[2] - a[0] - a[2]), f),
            b[1] += (a[0] - a[2]) / 2);
            h < b[2] ? (b[2] = h,
    ...
    (function(a) {
        ...
        D.prototype.callbacks.push(function(a) {
            function f() {
                ...
                A(a.series || [], function(a) {
                    ...
                    (h.enabled || a._hasPointLabels) && !h.allowOverlap && a.visible && A(l, function(e) {
                        A(a.points, function(a) {
                            a[e] && (a[e].labelrank = G(a.labelrank, a.shapeArgs && a.shapeArgs.height),
                            f.push(a[e]))
                        })
                    })
                });
        ...
        D.prototype.hideOverlappingLabels = function(a) {
            var f = a.length, h, l, n, t, e, d, m, C, b, x = function(a, b, d, e, f, h, l, m) {
            ...
            for (l = 0; l < f; l++)
                ...
                h = l + 1; h < f; ++h)
                    if (t = a[h],
                    n && t && n !== t && n.placed && t.placed && 0 !== n.newOpacity && 0 !== t.newOpacity && (e = n.alignAttr,
                    d = t.alignAttr,
                    m = n.parentGroup,
                    C = t.parentGroup,
                    b = 2 * (n.box ? 0 : n.padding),
                    e = x(e.x + m.translateX, e.y + m.translateY, n.width - b, n.height - b, d.x + C.translateX, d.y + C.translateY, t.width - b, t.height - b)))
                        (n.labelrank < t.labelrank ? n : t).newOpacity = 0;
            A(a, function(a) {
                var b, c;
                a && (c = a.newOpacity,
    ...
    (function(a) {
        var D = a.addEvent, A = a.Chart, G = a.createElement, F = a.css, n = a.defaultOptions, f = a.defaultPlotOptions, h = a.each, l = a.extend, w = a.fireEvent, t = a.hasTouch, e = a.inArray, d = a.isObject, m = a.Legend, C = a.merge, b = a.pick, x = a.Point, c = a.Series, u = a.seriesTypes, B = a.svg, I;
        I = a.TrackerMixin = {
            ...
            drawTrackerGraph: function() {
                var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, l = f.pointer, m = f.renderer, n = f.options.tooltip.snap, g = a.tracker, r, u = function() {
                    if (f.hoverSeries !== a)
                        a.onMouseOver()
                }, w = "rgba(192,192,192," + (B ? .0001 : .002) + ")";
                if (e && !c)
                    for (r = e + 1; r--; )
                        "M" === d[r] && d.splice(r + 1, 0, d[r + 1] - n, d[r + 2], "L"),
                        (r && "M" === d[r] || r === e) && d.splice(r, 0, "L", d[r - 2] + n, d[r - 1]);
                g ? g.attr({
                    d: d
                ...
                h([a.tracker, a.markerGroup], function(a) {
        ...
        l(A.prototype, {
            ...
            pan: function(a, b) {
                ...
                h("xy" === b ? [1, 0] : [1], function(b) {
                    b = c[b ? "xAxis" : "yAxis"][0];
                    var d = b.horiz, f = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", h = c[d], g = (b.pointRange || 0) / 2, k = b.getExtremes(), l = b.toValue(h - f, !0) + g, g = b.toValue(h + b.len - f, !0) - g, m = g < l, h = m ? g : l, l = m ? l : g, g = Math.min(k.dataMin, b.toValue(b.toPixels(k.min) - b.minPixelPadding)), m = Math.max(k.dataMax, b.toValue(b.toPixels(k.max) + b.minPixelPadding)), n;
                    n = g - h;
                    0 < n && (l += n,
                    h = g);
                    n = l - m;
        ...
        l(x.prototype, {
            select: function(a, c) {
                ...
                d.firePointEvent(a ? "select" : "unselect", {
                    ...
                    c || h(k.getSelectedPoints(), function(a) {
                        a.selected && a !== d && (a.selected = a.options.selected = !1,
            ...
            setState: function(a, c) {
                var d = Math.floor(this.plotX), e = this.plotY, h = this.series, k = h.options.states[a] || {}, m = f[h.type].marker && h.options.marker, n = m && !1 === m.enabled, t = m && m.states && m.states[a] || {}, g = !1 === t.enabled, r = h.stateMarkerGraphic, u = this.marker || {}, w = h.chart, x = h.halo, A, E = m && h.markerAttribs;
                a = a || "";
                if (!(a === this.state && !c || this.selected && "select" !== a || !1 === k.enabled || a && (g || n && !1 === t.enabled) || a && u.states && u.states[a] && !1 === u.states[a].enabled)) {
                    E && (A = h.markerAttribs(this, a));
                    if (this.graphic)
                        this.state && this.graphic.removeClass("highcharts-point-" + this.state),
                        a && this.graphic.addClass("highcharts-point-" + a),
                        this.graphic.attr(h.pointAttribs(this, a)),
                        A && this.graphic.animate(A, b(w.options.chart.animation, t.animation, m.animation)),
                        r && r.hide();
                    else {
                        if (a && t) {
                            m = u.symbol || h.symbol;
                            ...
                            if (r)
                                ...
                                m && (h.stateMarkerGraphic = r = w.renderer.symbol(m, A.x, A.y, A.width, A.height).add(h.markerGroup),
                                r.currentSymbol = m);
                            r && r.attr(h.pointAttribs(this, a))
                        }
                        r && (r[a && w.isInsidePlot(d, e, w.inverted) ? "show" : "hide"](),
                        r.element.point = this)
                    }
                    (d = k.halo) && d.size ? (x || (h.halo = x = w.renderer.path().add(E ? h.markerGroup : h.group)),
                    x[c ? "animate" : "attr"]({
        ...
        l(c.prototype, {
            ...
            setState: function(a) {
                ...
                c.state = a,
                !f[a] || !1 !== f[a].enabled) && (a && (k = f[a].lineWidth || k + (f[a].lineWidthPlus || 0)),
                e && !e.dashstyle))
                    for (k = {
                        "stroke-width": k
                    },
                    e.animate(k, b(c.chart.options.chart.animation, f[a] && f[a].animation)); c["zone-graph-" + d]; )
                        c["zone-graph-" + d].attr(k),
                        d += 1
            },
    ...
    (function(a) {
        var D = a.Chart
          ...
          , f = a.pick
          , h = a.splat;
        D.prototype.setResponsive = function(f) {
            ...
            var d = a.merge.apply(0, a.map(l, function(d) {
              ...
              , l = l.toString() || void 0;
            l !== (e && e.ruleIds) && (e && this.update(e.undoOptions, f),
            ...
            function l(e, d, f, t) {
                ...
                a.objectEach(e, function(a, c) {
                    if (!t && -1 < G(c, ["series", "xAxis", "yAxis"]))
                        ...
                        b = 0; b < e[c].length; b++)
                            d[c][b] && (f[c][b] = {},
                            l(a[b], d[c][b], f[c][b], t + 1));
                    else
                        n(a) ? (f[c] = F(a) ? [] : {},
                        l(a, d[c] || {}, f[c], t + 1)) : f[c] = d[c] || null
                })
            }
            var t = {};
